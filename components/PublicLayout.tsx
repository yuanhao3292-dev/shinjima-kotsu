              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 lg:gap-6">
                <div className="col-span-2">
                  ...
                  <div className="space-y-1.5 text-sm text-neutral-600 mb-4">
                    ...
                    <div><a href="tel:06-6632-8807" className="hover:text-neutral-900 transition-colors">TEL: 06-6632-8807</a></div>
                  </div>
                </div>
                <div>
                  <h4 className="text-xs font-medium tracking-wider text-neutral-800 uppercase mb-4">服务项目</h4>
                  <ul className="space-y-2.5">
                    <li><a href="/medical" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">精密体检</a></li>
                    <li><a href="/cancer-treatment" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">癌症治疗</a></li>
                    <li><a href="/golf" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">名门高尔夫</a></li>
                    <li><a href="/business" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">商务考察</a></li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-xs font-medium tracking-wider text-neutral-800 uppercase mb-4">合作伙伴</h4>
                  <ul className="space-y-2.5">
                    <li><a href="/guide-partner" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">导游伙伴计划</a></li>
                    <li><a href="/business/partner" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">商务合作</a></li>
                    <li><a href="/login?redirect=/health-screening" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">AI 健康评估</a></li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-xs font-medium tracking-wider text-neutral-800 uppercase mb-4">公司资讯</h4>
                  <ul className="space-y-2.5">
                    <li><Link href="/company/about" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">关于我们</Link></li>
                    <li><Link href="/news" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">最新消息</Link></li>
                    <li><Link href="/faq" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">常见问题</Link></li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-xs font-medium tracking-wider text-neutral-800 uppercase mb-4">法律条款</h4>
                  <ul className="space-y-2.5">
                    <li><Link href="/legal/tokushoho" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">特定商取引法</Link></li>
                    <li><a href="/legal/yakkan" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">旅行業约款</a></li>
                    <li><Link href="/legal/privacy" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">隐私政策</Link></li>
                    <li><Link href="/legal/terms" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">使用条款</Link></li>
                    <li><a href="/legal/medical-disclaimer" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">医疗免责事项</a></li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div className="container mx-auto px-6 py-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div className="text-center md:text-left">
                    <p className="text-xs text-neutral-500">大阪府知事登録旅行業 第2-3115号 ｜ 一般社団法人 日本旅行業協会（JATA）正会員</p>
                  </div>
                  <div className="text-center md:text-right">
                    <p className="text-xs text-neutral-500">&copy; {new Date().getFullYear()} 新岛交通株式会社. All rights reserved.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="relative max-w-[1400px] mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <div className="relative lang-dropdown">
              ...
              {langMenuOpen && (
                <div className="absolute right-0 mt-2 w-32 bg-white rounded-lg shadow-xl border border-neutral-100 py-2 z-50 animate-fade-in-down">
            ...
            <div className="relative hidden md:block login-dropdown">
              ...
              {loginMenuOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-neutral-100 py-2 z-50 animate-fade-in-down">
                  <Link
                    href="/login"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-neutral-400">{t.memberLoginDesc}</p>
                    </div>
                  </Link>
                  {!hideGuidePartnerContent && (
                    <Link
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-neutral-400">{t.guideLoginDesc}</p>
                      </div>
                    </Link>
                  )}
                </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed top-20 left-0 w-full h-[calc(100vh-80px)] bg-white z-40 p-6 flex flex-col gap-6 overflow-y-auto animate-fade-in-down">
          ...
          <div className="mt-6 space-y-3">
            <p className="text-sm text-neutral-500 uppercase tracking-wider font-medium">{t.login}</p>
            <Link
              href="/login"
        ...
        <footer className="bg-white text-neutral-800 border-t border-neutral-200">
          ...
          <div className="container mx-auto px-6 py-16">
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 lg:gap-6">
              ...
              <div className="col-span-2">
                ...
                {hideOfficialBranding ? (
                  ...
                  <div className="space-y-1.5 text-sm text-neutral-600 mb-4">
                    ...
                    <div>
                      <ObfuscatedEmail user="haoyuan" domain="niijima-koutsu.jp" className="hover:text-neutral-900 transition-colors" />
                    </div>
                  </div>
                )}
                {/* 社交媒体图标 */}
                {!hideOfficialBranding && (
                  <div className="flex items-center gap-3">
                    <a href="https://wa.me/818012345678" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-neutral-800/5 hover:bg-neutral-800/10 flex items-center justify-center transition-colors text-neutral-500 hover:text-neutral-700" aria-label="WhatsApp">
                    ...
                    <a href="#" className="w-8 h-8 rounded-full bg-neutral-800/5 hover:bg-neutral-800/10 flex items-center justify-center transition-colors text-neutral-500 hover:text-neutral-700" aria-label="WeChat">
                    ...
                    <a href="https://line.me/ti/p/~niijima-koutsu" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-neutral-800/5 hover:bg-neutral-800/10 flex items-center justify-center transition-colors text-neutral-500 hover:text-neutral-700" aria-label="LINE">
              ...
              {/* 服务项目 */}
              <div>
                <h4 className="text-xs font-medium tracking-wider text-neutral-800 uppercase mb-4">{t.footerServices}</h4>
                <ul className="space-y-2.5">
                  <li>
                    <Link href="/medical" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                      {t.timc}
                    </Link>
                  </li>
                  <li>
                    <Link href="/cancer-treatment" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                      {t.cancer}
                    </Link>
                  </li>
                  <li>
                    <Link href="/golf" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                      {t.golf}
                    </Link>
                  </li>
                  <li>
                    <Link href="/business" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                      {t.business}
                    </Link>
                  </li>
                </ul>
              ...
              {/* 合作伙伴 */}
              <div>
                <h4 className="text-xs font-medium tracking-wider text-neutral-800 uppercase mb-4">{t.footerPartners}</h4>
                <ul className="space-y-2.5">
                  <li>
                    <Link href="/guide-partner" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                      {t.guidePartner}
                    </Link>
                  </li>
                  <li>
                    <Link href="/business/partner" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                      {t.partner}
                    </Link>
                  </li>
                  <li>
                    <Link href="/login?redirect=/health-screening" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
              ...
              {/* 公司信息 */}
              <div>
                <h4 className="text-xs font-medium tracking-wider text-neutral-800 uppercase mb-4">{t.footerCompanyInfo}</h4>
                <ul className="space-y-2.5">
                  <li>
                    <Link href="/company/about" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                      {t.footerAbout}
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="/faq" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                      {t.footerFaq}
                    </Link>
                  </li>
                </ul>
              ...
              {/* 法律条款 */}
              <div>
                <h4 className="text-xs font-medium tracking-wider text-neutral-800 uppercase mb-4">{t.footerLegal}</h4>
                <ul className="space-y-2.5">
                  <li>
                    <Link href="/legal/tokushoho" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                      {t.footerTokushoho}
                    </Link>
                  </li>
                  <li>
                    <Link href="/legal/yakkan" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                      {t.footerYakkan}
                    </Link>
                  </li>
                  <li>
                    <Link href="/legal/privacy" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                      {t.footerPrivacy}
                    </Link>
                  </li>
                  <li>
                    <Link href="/legal/terms" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
                      {t.footerTerms}
                    </Link>
                  </li>
                  <li>
                    <Link href="/legal/medical-disclaimer" className="text-sm text-neutral-600 hover:text-neutral-900 transition-colors">
