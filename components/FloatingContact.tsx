        ...
        >
          ...
          >
            ...
            <a
              ...
              className="mt-4 w-full flex items-center justify-center gap-2 bg-brand-700 hover:bg-brand-800 text-white py-3 rounded-xl font-medium transition-all duration-200"
            >
            ...
            <div className="space-y-3">
              ...
              {displayLine ? (
                <button
                  ...
                  className="w-full flex items-center gap-3 bg-brand-700 hover:bg-brand-800 text-white px-4 py-3 rounded-xl transition-all duration-200 shadow-lg shadow-brand-200"
                >
              ...
              <button
                ...
                className="w-full flex items-center gap-3 bg-brand-700 hover:bg-brand-800 text-white px-4 py-3 rounded-xl transition-all duration-200"
              >
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
