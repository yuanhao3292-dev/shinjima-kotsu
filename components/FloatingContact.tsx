        ...
        >
          ...
          >
            ...
            <a
              ...
              className="mt-4 w-full flex items-center justify-center gap-2 bg-[#06C755] hover:bg-[#05b34c] text-white py-3 rounded-xl font-medium transition-all duration-200"
            >
            ...
            <div className="space-y-3">
              ...
              {displayLine ? (
                <button
                  ...
                  className="w-full flex items-center gap-3 bg-[#06C755] hover:bg-[#05b34c] text-white px-4 py-3 rounded-xl transition-all duration-200 shadow-lg shadow-brand-200"
                >
