...
const translations: Record<string, Record<Language, string>> = {
  front: { ja: '前面', 'zh-CN': '正面', 'zh-TW': '正面', en: 'Front', ko: '전면' },
  back: { ja: '背面', 'zh-CN': '背面', 'zh-TW': '背面', en: 'Back', ko: '후면' },
  partSymptoms: { ja: 'の症状', 'zh-CN': '症状', 'zh-TW': '症狀', en: ' Symptoms', ko: ' 증상' },
  generalShort: { ja: '全', 'zh-CN': '全', 'zh-TW': '全', en: 'All', ko: '전' },
  generalSymptoms: { ja: '全身症状', 'zh-CN': '全身症状', 'zh-TW': '全身症狀', en: 'General Symptoms', ko: '전신 증상' },
  symptomProgress: { ja: '症状', 'zh-CN': '症状', 'zh-TW': '症狀', en: 'Symptom', ko: '증상' },
  questionProgress: { ja: '質問', 'zh-CN': '问题', 'zh-TW': '問題', en: 'Question', ko: '질문' },
  notSure: { ja: 'わからない', 'zh-CN': '我不确定', 'zh-TW': '我不確定', en: 'Not sure', ko: '잘 모르겠습니다' },
  next: { ja: '次へ', 'zh-CN': '下一步', 'zh-TW': '下一步', en: 'Next', ko: '다음' },
  riskLow: { ja: '低リスク', 'zh-CN': '低风险', 'zh-TW': '低風險', en: 'Low Risk', ko: '낮은 위험도' },
  riskMedium: { ja: '中リスク', 'zh-CN': '中风险', 'zh-TW': '中風險', en: 'Medium Risk', ko: '중간 위험도' },
  riskHigh: { ja: '高リスク', 'zh-CN': '高风险', 'zh-TW': '高風險', en: 'High Risk', ko: '높은 위험도' },
  riskDescription: {
    ...
    ko: '선택하신 증상을 바탕으로 시스템이 건강 위험도를 초기 평가했습니다',
  },
  selectedParts: { ja: '選択した部位', 'zh-CN': '已选择的部位', 'zh-TW': '已選擇的部位', en: 'Selected Body Parts', ko: '선택한 부위' },
  selectedSymptoms: { ja: '選択した症状', 'zh-CN': '已选择的症状', 'zh-TW': '已選擇的症狀', en: 'Selected Symptoms', ko: '선택한 증상' },
  severityHigh: { ja: '高', 'zh-CN': '高', 'zh-TW': '高', en: 'High', ko: '높음' },
  severityMedium: { ja: '中', 'zh-CN': '中', 'zh-TW': '中', en: 'Med', ko: '중간' },
  severityLow: { ja: '低', 'zh-CN': '低', 'zh-TW': '低', en: 'Low', ko: '낮음' },
  recommendedDepts: { ja: '推奨診療科', 'zh-CN': '推荐就诊科室', 'zh-TW': '推薦就診科室', en: 'Recommended Departments', ko: '권장 진료과' },
  aiDescription: {
    ...
    ko: '다음으로, AI가 선택 내용을 바탕으로 더 상세한 건강 문진을 진행하고 전문 건강 평가 보고서를 작성합니다.',
  },
  stepBodySelectTitle: { ja: '不調のある部位を選択', 'zh-CN': '选择不适部位', 'zh-TW': '選擇不適部位', en: 'Select Affected Areas', ko: '불편한 부위 선택' },
  stepSymptomSelectTitle: { ja: '具体的な症状を選択', 'zh-CN': '选择具体症状', 'zh-TW': '選擇具體症狀', en: 'Select Specific Symptoms', ko: '구체적인 증상 선택' },
  stepFollowUpTitle: { ja: '詳細問診', 'zh-CN': '详细问诊', 'zh-TW': '詳細問診', en: 'Detailed Inquiry', ko: '상세 문진' },
  stepSummaryTitle: { ja: '問診まとめ', 'zh-CN': '问诊总结', 'zh-TW': '問診總結', en: 'Consultation Summary', ko: '문진 요약' },
  stepBodySelectDesc: {
    ...
    ko: '인체도에서 불편한 부위를 클릭해 주세요 (복수 선택 가능)',
  },
  ...
  stepFollowUpDesc: {
    ...
    ko: '몇 가지 간단한 추가 질문에 답변해 주세요. 더 정확한 평가에 도움이 됩니다',
  },
  stepSummaryDesc: {
    ja: '以下は問診のまとめです',
    'zh-CN': '以下是您的问诊总结',
  ...
  selectedPartsLabel: { ja: '選択した部位：', 'zh-CN': '已选择的部位：', 'zh-TW': '已選擇的部位：', en: 'Selected:', ko: '선택한 부위:' },
  goBack: { ja: '戻る', 'zh-CN': '返回', 'zh-TW': '返回', en: 'Back', ko: '이전' },
  nextSelectSymptoms: { ja: '次へ：症状を選択', 'zh-CN': '下一步：选择症状', 'zh-TW': '下一步：選擇症狀', en: 'Next: Select Symptoms', ko: '다음: 증상 선택' },
  nextDetailedInquiry: { ja: '次へ：詳細問診', 'zh-CN': '下一步：详细问诊', 'zh-TW': '下一步：詳細問診', en: 'Next: Detailed Inquiry', ko: '다음: 상세 문진' },
  skipSymptomSelection: { ja: '症状選択をスキップ', 'zh-CN': '跳过症状选择', 'zh-TW': '跳過症狀選擇', en: 'Skip Symptom Selection', ko: '증상 선택 건너뛰기' },
  startAiAnalysis: { ja: 'AI 健康分析を開始', 'zh-CN': '开始 AI 健康分析', 'zh-TW': '開始 AI 健康分析', en: 'Start AI Health Analysis', ko: 'AI 건강 분석 시작' },
};

const bodyPartNames: Record<string, Record<Language, string>> = {
  head: { ja: '頭部', 'zh-CN': '头部', 'zh-TW': '頭部', en: 'Head', ko: '머리' },
  neck: { ja: '首', 'zh-CN': '颈部', 'zh-TW': '頸部', en: 'Neck', ko: '목' },
  chest: { ja: '胸部', 'zh-CN': '胸部', 'zh-TW': '胸部', en: 'Chest', ko: '가슴' },
  abdomen: { ja: '腹部', 'zh-CN': '腹部', 'zh-TW': '腹部', en: 'Abdomen', ko: '복부' },
  pelvis: { ja: '骨盤/下腹部', 'zh-CN': '骨盆/下腹', 'zh-TW': '骨盆/下腹', en: 'Pelvis', ko: '골반/하복부' },
  'left-arm': { ja: '左腕', 'zh-CN': '左臂', 'zh-TW': '左臂', en: 'Left Arm', ko: '왼팔' },
  'right-arm': { ja: '右腕', 'zh-CN': '右臂', 'zh-TW': '右臂', en: 'Right Arm', ko: '오른팔' },
  'left-leg': { ja: '左脚', 'zh-CN': '左腿', 'zh-TW': '左腿', en: 'Left Leg', ko: '왼다리' },
  'right-leg': { ja: '右脚', 'zh-CN': '右腿', 'zh-TW': '右腿', en: 'Right Leg', ko: '오른다리' },
  back: { ja: '背中', 'zh-CN': '背部', 'zh-TW': '背部', en: 'Back', ko: '등' },
};
            ...
            return (
              <g key={part.id}>
                <path
                  ...
                  stroke={isSelected ? '#b13e22' : '#f0937c'}
          ...
          {viewMode === 'back' && (
            <g>
              ...
              <path
                ...
                stroke={selectedBodyParts.includes('back') ? '#b13e22' : '#f0937c'}
