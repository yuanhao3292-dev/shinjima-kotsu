...
const translations: Record<string, Record<Language, string>> = {
  ...
  analysisFailedRetry: {
    ...
    ko: '분석 요청에 실패했습니다. 잠시 후 다시 시도해 주세요',
  },
  canSelectMultiple: {
    ja: '複数選択可能',
    'zh-CN': '可选择多个选项',
  ...
  phase1CompleteDesc: {
    ja: '10問のクイックチェックが完了しました。次の操作をお選びください：',
    ...
    ko: '10개의 빠른 검진 질문을 완료했습니다. 다음 중 선택해 주세요:',
  },
  getResultsNow: {
    ja: '今すぐ結果を取得',
    'zh-CN': '立即获取结果',
  ...
  getResultsNowDesc: {
    ...
    ko: '답변 내용을 바탕으로 초기 건강 조언 및 권장 검사 항목을 생성합니다',
  },
  aiAnalyzing: {
    ja: 'AI 分析中...',
    'zh-CN': 'AI 分析中...',
  ...
  continueInDepthDesc: {
    ...
    ko: '{n}개의 추가 질문에 답변하여 더 상세하고 정확한 건강 분석 보고서를 받으세요',
  },
  recommended: {
    ja: 'おすすめ',
    'zh-CN': '推荐',
  ...
  phase1Hint: {
    ...
    ko: '완료 후 즉시 초기 조언을 받거나 심층 문진을 계속할 수 있습니다',
  },
  smartConsultation: {
    ja: 'スマート問診モード',
    'zh-CN': '智能问诊模式',
  ...
  smartConsultationDesc: {
    ...
    ko: '선택하신 불편 부위를 바탕으로 AI가 심층 문진 과정을 최적화했습니다',
  },
  questionProgress: {
    ja: '質問 {n} / {total}',
    'zh-CN': '问题 {n} / {total}',
  ...
  autoSaveHint: {
    ...
    ko: '답변은 자동으로 저장됩니다. 언제든지 돌아와서 이어서 답변할 수 있습니다',
  },
  reportLanguage: {
    ja: 'レポート言語',
    'zh-CN': '报告语言',
    ...
    return (
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-semibold text-neutral-900 tracking-wide mb-4">
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 mb-6">
        <h2 className="text-xl md:text-2xl font-semibold text-neutral-900 tracking-wide mb-6">
