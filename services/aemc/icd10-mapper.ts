...
const ICD10_DATABASE: ICD10Entry[] = [
  // ============ 恶性肿瘤 ============
  { code: 'C22.0', nameCn: '肝细胞癌', nameJa: '肝細胞癌', nameEn: 'Hepatocellular carcinoma', keywords: ['肝细胞癌', '肝癌', 'hcc', 'hepatocellular carcinoma', '肝細胞癌'] },
  { code: 'C22.1', nameCn: '肝内胆管细胞癌', nameJa: '肝内胆管癌', nameEn: 'Intrahepatic cholangiocarcinoma', keywords: ['胆管细胞癌', 'cholangiocarcinoma', '胆管癌', 'intrahepatic', '肝内胆管'] },
  ...
  { code: 'C80.0', nameCn: '原发灶不明恶性肿瘤', nameJa: '原発不明癌', nameEn: 'Cancer of unknown primary (CUP)', keywords: ['原发灶不明', '原发不明', 'unknown primary', 'cup', '原発不明'] },
  ...
  // ============ 心血管 ============
  { code: 'I25.1', nameCn: '冠状动脉粥样硬化性心脏病', nameJa: '冠動脈硬化性心疾患', nameEn: 'Atherosclerotic heart disease', keywords: ['冠心病', '冠状动脉', 'coronary', 'atherosclerotic heart', '冠動脈硬化', 'cad'] },
  { code: 'I21', nameCn: '急性心肌梗死', nameJa: '急性心筋梗塞', nameEn: 'Acute myocardial infarction', keywords: ['心肌梗死', 'myocardial infarction', '心筋梗塞', 'acs', '急性冠脉'] },
  { code: 'I50', nameCn: '心力衰竭', nameJa: '心不全', nameEn: 'Heart failure', keywords: ['心力衰竭', 'heart failure', '心不全', 'hfrEF', 'hfpEF'] },
  { code: 'I48', nameCn: '心房颤动和心房扑动', nameJa: '心房細動', nameEn: 'Atrial fibrillation and flutter', keywords: ['房颤', 'atrial fibrillation', '心房細動', 'afib'] },
  { code: 'I10', nameCn: '原发性高血压', nameJa: '本態性高血圧', nameEn: 'Essential hypertension', keywords: ['高血压', 'hypertension', '高血圧'] },
  { code: 'I63', nameCn: '脑梗死', nameJa: '脳梗塞', nameEn: 'Cerebral infarction', keywords: ['脑梗', '脑卒中', 'stroke', 'cerebral infarction', '脳梗塞'] },
  ...
  // ============ 肾脏 ============
  { code: 'N18', nameCn: '慢性肾脏病', nameJa: '慢性腎臓病', nameEn: 'Chronic kidney disease', keywords: ['慢性肾', 'ckd', 'chronic kidney', '慢性腎', '肾功能不全'] },
  { code: 'N17', nameCn: '急性肾损伤', nameJa: '急性腎障害', nameEn: 'Acute kidney injury', keywords: ['急性肾', 'aki', 'acute kidney', '急性腎'] },
  ...
  { code: 'E05', nameCn: '甲状腺功能亢进', nameJa: '甲状腺機能亢進症', nameEn: 'Thyrotoxicosis', keywords: ['甲亢', 'hyperthyroid', '甲状腺機能亢進', 'graves'] },
  { code: 'E03', nameCn: '甲状腺功能减退', nameJa: '甲状腺機能低下症', nameEn: 'Hypothyroidism', keywords: ['甲减', 'hypothyroid', '甲状腺機能低下', '橋本'] },

  // ============ 肝脏（非肿瘤） ============
  { code: 'B18.1', nameCn: '慢性乙型肝炎', nameJa: '慢性B型肝炎', nameEn: 'Chronic viral hepatitis B', keywords: ['乙肝', 'hepatitis b', 'hbv', 'b型肝炎'] },
  { code: 'B18.2', nameCn: '慢性丙型肝炎', nameJa: '慢性C型肝炎', nameEn: 'Chronic viral hepatitis C', keywords: ['丙肝', 'hepatitis c', 'hcv', 'c型肝炎'] },
  { code: 'K74', nameCn: '肝纤维化和肝硬化', nameJa: '肝線維症・肝硬変', nameEn: 'Fibrosis and cirrhosis of liver', keywords: ['肝硬化', 'cirrhosis', '肝硬変', '肝纤维化'] },

  // ============ 呼吸 ============
  { code: 'I26', nameCn: '肺栓塞', nameJa: '肺塞栓症', nameEn: 'Pulmonary embolism', keywords: ['肺栓塞', 'pulmonary embolism', '肺塞栓', 'pe'] },
  ...
  { code: 'I60', nameCn: '蛛网膜下腔出血', nameJa: 'くも膜下出血', nameEn: 'Subarachnoid hemorrhage', keywords: ['蛛网膜下腔', 'subarachnoid', 'くも膜下', 'sah'] },
