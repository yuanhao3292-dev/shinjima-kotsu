...
export type EmailLocale = 'ja' | 'zh-CN' | 'zh-TW' | 'en' | 'ko';
...
export const common = {
  ...
  footerDisclaimer: {
    ...
    ko: '이 이메일은 시스템에서 자동 발송되었습니다. 직접 회신하지 마십시오.',
  },
  contactPrompt: {
...
export const orderConfirmation = {
  ...
  subject: {
    ...
    ko: '【TIMC】예약이 확인되었습니다 - 주문 #{{orderId}}',
  },
  statusTitle: {
    ja: '予約完了！',
    'zh-CN': '预约成功！',
  ...
  statusSubtitle: {
    ...
    ko: 'TIMC OSAKA를 선택해 주셔서 감사합니다. 예약이 접수되었습니다.',
  },
  detailsTitle: {
    ja: '注文詳細',
    'zh-CN': '订单详情',
  ...
  nextStep1: {
    ...
    ko: '담당 직원이 <strong>1~2 영업일 이내</strong>에 연락드려 검진일을 확정합니다',
  },
  nextStep2: {
    ...
    ko: '확정 후 <strong>검진 안내</strong>와 <strong>주의사항</strong>을 보내드립니다',
  },
  nextStep3: {
    ...
    ko: '검진 전날 <strong>리마인더 알림</strong>을 보내드립니다',
  },
  nextStep4: {
    ...
    ko: '검진 완료 후 <strong>7~10 영업일</strong> 이내에 보고서를 전달합니다',
  },
  facilityTitle: {
    ja: '📍 健診会場',
    'zh-CN': '📍 体检地点',
  ...
  facilityName: {
    ...
    ko: 'TOKUSHUKAI INTERNATIONAL Medical Check-up OSAKA（TIMC OSAKA）',
  },
  facilityAddress: {
    ja: '〒530-0001\n大阪市北区梅田三丁目2番2号\nJP TOWER OSAKA 11階\nTEL: 06-7777-3353',
    'zh-CN': '〒530-0001\n大阪市北区梅田三丁目2番2号\nJP TOWER OSAKA 11楼\nTEL: 06-7777-3353',
...
export const orderConfirmationGeneric = {
  ...
  statusSubtitle: {
    ...
    ko: '예약이 접수되었습니다. 담당자가 빠른 시일 내에 연락드리겠습니다.',
  },
  labelPackage: {
    ja: 'サービス内容',
    'zh-CN': '服务内容',
  ...
  nextStep1: {
    ...
    ko: '담당 직원이 <strong>24시간 이내</strong>에 연락드립니다',
  },
  nextStep2: {
    ...
    ko: '고객님의 요구사항을 파악한 후 <strong>최적의 플랜</strong>을 제안합니다',
  },
  nextStep3: {
    ...
    ko: '<strong>상세 견적</strong>과 <strong>일정</strong>을 안내합니다',
  },
  footerSubtitle: {
    ja: '日本医療コーディネーター',
    'zh-CN': '日本医疗协调服务',
...
export const whitelabelSubscription = {
  subject: {
    ...
    ko: '🎉 화이트라벨 등록 완료 - NIIJIMA 가이드 파트너',
  },
  statusTitle: {
    ja: '登録完了！',
    'zh-CN': '订阅成功！',
  ...
  message: {
    ...
    ko: '화이트라벨 페이지 등록이 완료되었습니다!\n브랜드 페이지를 설정하여 고객에게 서비스를 소개하세요.',
  },
  detailsTitle: {
    ja: '📋 登録内容',
    'zh-CN': '📋 订阅详情',
  ...
  step1: {
    ...
    ko: '<strong>URL 슬러그</strong>를 설정 (예: bespoketrip.jp/p/your-name)',
  },
  step2: {
    ...
    ko: '<strong>브랜드명</strong>과 <strong>브랜드 컬러</strong>를 커스터마이즈',
  },
  step3: {
    ...
    ko: '<strong>연락처</strong> (WeChat, LINE, 전화)를 추가',
  },
  step4: {
...
export const guideCommission = {
  ...
  bonusBanner: {
    ...
    ko: '🎁 <strong>신규 고객 첫 주문 보너스 +5%</strong>가 자동 적용되었습니다!',
  },
  ctaText: {
    ja: 'コミッション詳細を見る',
    'zh-CN': '查看佣金详情',
...
export const kycNotification = {
  subjectApproved: {
    ...
    ko: '🎉 본인 인증이 승인되었습니다 - NIIJIMA 가이드 파트너',
  },
  subjectRejected: {
    ...
    ko: '⚠️ 본인 인증이 승인되지 않았습니다 - NIIJIMA 가이드 파트너',
  },
  statusApproved: {
    ja: '認証完了',
    'zh-CN': '验证通过',
  ...
  messageApproved: {
    ...
    ko: '본인 인증이 승인되었습니다. 화이트라벨 페이지를 사용하여 고객 유치를 시작하세요.',
  },
  messageRejected: {
    ...
    ko: '죄송합니다. 본인 인증이 승인되지 않았습니다. 제출 서류를 확인하신 후 다시 신청해 주세요.',
  },
  reviewNoteLabel: {
    ja: '審査メモ',
    'zh-CN': '审核备注',
...
export const guideRegistration = {
  subject: {
    ...
    ko: '등록 완료! NIIJIMA 가이드 파트너에 오신 것을 환영합니다',
  },
  statusTitle: {
    ja: '登録完了！',
    'zh-CN': '注册成功！',
  ...
  greeting: {
    ...
    ko: '{{name}} 님, 가이드 파트너 프로그램에 오신 것을 환영합니다',
  },
  detailsTitle: {
    ja: 'アカウント情報',
    'zh-CN': '您的账户信息',
  ...
  step1: {
    ...
    ko: '로그인 후 <strong>가이드 파트너 대시보드</strong>에 접속',
  },
  step2: {
    ...
    ko: '<strong>추천 코드 {{code}}</strong>를 고객에게 공유',
  },
  step3: {
    ...
    ko: '고객이 추천 링크로 예약하면 <strong>커미션</strong>이 발생',
  },
  step4: {
    ...
    ko: '<strong>화이트라벨 페이지</strong>를 개설하여 전용 브랜드를 구축',
  },
  ctaText: {
    ja: 'ログインする',
    'zh-CN': '立即登录',
...
export const refundNotification = {
  ...
  footerNote: {
    ...
    ko: '환불은 카드사 처리에 따라 5~10 영업일 소요될 수 있습니다',
  },
  contactNote: {
    ...
    ko: '궁금한 점은 니지마 교통 고객지원으로 문의해 주세요 (TEL: 06-7777-3353)',
  },
} as const;
...
export const healthCheckupReminder = {
  subject: {
    ...
    ko: '🏥 연간 건강검진 안내 (지난 검진 후 {{months}}개월)',
  },
  subjectHighRisk: {
    ...
    ko: '⚠️ 건강 후속 검진이 필요합니다 (지난 검진 후 {{months}}개월)',
  },
  statusTitle: {
    ja: '定期健康チェックの時期です',
    'zh-CN': '是时候进行定期健康检查了',
  ...
  message: {
    ...
    ko: '정기 건강검진은 최고의 예방책입니다. 지난 검진으로부터 시간이 지났습니다. 최신 건강 상태를 확인하세요.',
  },
  messageHighRisk: {
    ...
    ko: '지난 검진에서 건강 위험 상승이 감지되었습니다. 연간 후속 검진을 강력히 권장합니다.',
  },
  monthsLabel: {
    ja: '前回から',
    'zh-CN': '距上次',
