...
export const SCREENING_QUESTIONS: ScreeningQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'dizziness', label: '头晕/眩晕' },
      { value: 'vision', label: '视力变化' },
      { value: 'memory', label: '记忆力下降' },
    ],
  ...
  // 心理健康 (PHQ-2)
  {
    ...
    category: 'mental',
    phase: 2,
    question: '过去两周内，您是否经常感到心情低落或对事物缺乏兴趣？',
    type: 'single',
    options: [
  ...
  // 其他重要信息
  {
    ...
    type: 'input',
    placeholder: '如有，请填写疾病/手术名称；如无，请填写「无」',
  },
];
