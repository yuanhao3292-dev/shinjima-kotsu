...
const pageTranslations = {
  serviceName: { ja: 'ACセルクリニック 遠隔診療サービス', 'zh-TW': 'AC Cell Clinic 遠程診斷服務', 'zh-CN': 'AC Cell Clinic 远程诊断服务', en: 'AC Cell Clinic Remote Consultation' } as Record<Language, string>,
  serviceNameEn: { ja: 'AC Cell Clinic - Remote Consultation', 'zh-TW': 'AC Cell Clinic - Remote Consultation', 'zh-CN': 'AC Cell Clinic - Remote Consultation', en: 'AC Cell Clinic - Remote Consultation' } as Record<Language, string>,
  serviceDescription: { ja: 'ACセルクリニック専門医とのビデオ診察・再生医療プラン詳細説明・費用詳細見積', 'zh-TW': '與AC Cell Clinic醫生遠程視頻會診、再生醫療方案評估、費用概算', 'zh-CN': '与AC Cell Clinic医生远程视频会诊、再生医疗方案评估、费用概算', en: 'Video consultation with AC Cell Clinic doctor, regenerative medicine assessment, cost estimation' } as Record<Language, string>,
  serviceLongDescription: { ja: 'ACセルクリニックの専門医と遠隔ビデオ診察を行い、専門医療通訳が全行程同行します。再生医療の適応性、培養計画、治療スケジュール、費用明細等を詳しくご説明し、来日治療の決断をサポートします。', 'zh-TW': '與AC Cell Clinic專科醫生進行遠程視頻會診，由專業醫療翻譯全程陪同。醫生將詳細說明再生醫療的適用性、培養計劃、治療時程、費用明細等，幫助您做出赴日治療的決定。', 'zh-CN': '与AC Cell Clinic专科医生进行远程视频会诊，由专业医疗翻译全程陪同。医生将详细说明再生医疗的适用性、培养计划、治疗时程、费用明细等，帮助您做出赴日治疗的决定。', en: 'Remote video consultation with AC Cell Clinic specialist, with professional medical interpreter. Doctor will explain regenerative medicine suitability, cultivation plan, treatment schedule, and cost details.' } as Record<Language, string>,
  ...
  feature1: { ja: 'ACセルクリニック専門医とのビデオ診察（約30-60分）', 'zh-TW': 'AC Cell Clinic專科醫生視頻會診（約30-60分鐘）', 'zh-CN': 'AC Cell Clinic专科医生视频会诊（约30-60分钟）', en: 'Video consultation with AC Cell Clinic specialist (30-60 mins)' } as Record<Language, string>,
  ...
  feature3: { ja: '再生医療の適応性評価', 'zh-TW': '再生醫療適用性評估', 'zh-CN': '再生医疗适用性评估', en: 'Regenerative medicine suitability assessment' } as Record<Language, string>,
  ...
  prereq3: { ja: 'ACセルクリニックの初期評価完了', 'zh-TW': 'AC Cell Clinic已完成初步評估', 'zh-CN': 'AC Cell Clinic已完成初步评估', en: 'AC Cell Clinic completed initial assessment' } as Record<Language, string>,
...
const SERVICE_INFO = {
  id: MEDICAL_PACKAGES['ac-plus-remote-consultation'].slug,
  slug: MEDICAL_PACKAGES['ac-plus-remote-consultation'].slug,
  price: MEDICAL_PACKAGES['ac-plus-remote-consultation'].priceJpy,
};

export default function ACPlusRemoteConsultationPage() {
