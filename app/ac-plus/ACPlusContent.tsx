...
const t = {
  ...
  acrs_desc: { ja: 'PRP療法の進化版。37°C処理で高濃度の抗炎症サイトカイン（IL-1ra, IL-4ra）を活性化', 'zh-TW': 'PRP療法的進化版。37°C處理激活高濃度抗炎細胞因子（IL-1ra, IL-4ra）', 'zh-CN': 'PRP疗法的进化版。37°C处理激活高浓度抗炎细胞因子（IL-1ra, IL-4ra）', en: 'Evolution of PRP therapy. 37°C processing activates high-concentration anti-inflammatory cytokines (IL-1ra, IL-4ra)' } as Record<Language, string>,
  ...
  bldgSub: { ja: '再生医療に特化した9階建て専用ビル', 'zh-TW': '專注再生醫療的9層專用大樓', 'zh-CN': '专注再生医疗的9层专用大楼', en: '9-floor building dedicated to regenerative medicine' } as Record<Language, string>,
