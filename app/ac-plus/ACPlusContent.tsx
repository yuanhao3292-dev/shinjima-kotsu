...
// ======================================
const t = {
  heroTag: { ja: '関西再生医療のベンチマーク', 'zh-TW': '關西再生醫療的標竿', 'zh-CN': '关西再生医疗的标杆', en: 'Kansai Regenerative Medicine Benchmark', ko: '간사이 재생의료의 벤치마크' } as Record<Language, string>,
  heroTitle: { ja: 'ACセルクリニック', 'zh-TW': 'AC Cell Clinic', 'zh-CN': 'AC Cell Clinic', en: 'AC Cell Clinic', ko: 'AC Cell Clinic' } as Record<Language, string>,
  heroSub: { ja: 'ACメディカルグループ — 9階建て専用ビルで提供する\n京都大学・大阪大学連携の再生医療', 'zh-TW': 'AC Medical Group — 9層專用大樓提供\n京都大學・大阪大學合作的再生醫療', 'zh-CN': 'AC Medical Group — 9层专用大楼提供\n京都大学·大阪大学合作的再生医疗', en: 'AC Medical Group — Regenerative medicine in a\n9-floor dedicated building, partnered with Kyoto & Osaka Universities', ko: 'AC Medical Group — 9층 전용 빌딩에서 제공하는\n교토대학·오사카대학 연계 재생의료' } as Record<Language, string>,
  ctaConsult: { ja: '無料相談を予約する', 'zh-TW': '預約免費諮詢', 'zh-CN': '预约免费咨询', en: 'Book Free Consultation', ko: '무료 상담 예약하기' } as Record<Language, string>,
  ctaLearn: { ja: '治療メニューを見る', 'zh-TW': '查看治療項目', 'zh-CN': '查看治疗项目', en: 'View Treatments', ko: '치료 메뉴 보기' } as Record<Language, string>,

  // Stats
  stat1: { ja: '累計患者数', 'zh-TW': '累計患者數', 'zh-CN': '累计患者数', en: 'Total Patients', ko: '누적 환자 수' } as Record<Language, string>,
  stat2: { ja: '開業年数', 'zh-TW': '開業年數', 'zh-CN': '开业年数', en: 'Years in Practice', ko: '개업 연수' } as Record<Language, string>,
  stat3: { ja: '厚労省認可計画数', 'zh-TW': '厚勞省認可計劃數', 'zh-CN': '厚劳省认可计划数', en: 'MHLW-Approved Plans', ko: '후생노동성 인가 계획 수' } as Record<Language, string>,
  stat4: { ja: 'CPC規格', 'zh-TW': 'CPC規格', 'zh-CN': 'CPC规格', en: 'CPC Standard', ko: 'CPC 규격' } as Record<Language, string>,

  // Intro
  introTag: { ja: 'クリニック紹介', 'zh-TW': '診所介紹', 'zh-CN': '诊所介绍', en: 'About the Clinic', ko: '클리닉 소개' } as Record<Language, string>,
  introTitle: { ja: 'ACメディカルグループの挑戦', 'zh-TW': 'AC Medical Group的挑戰', 'zh-CN': 'AC Medical Group的挑战', en: 'The AC Medical Group Mission', ko: 'AC Medical Group의 도전' } as Record<Language, string>,
  introP1: { ja: '2006年に大阪で設立されたACメディカルグループは、再生医療に特化した医療機関として18年以上の実績を持ちます。大阪市中央区に9階建ての専用ビル「日本細胞ビル」を構え、培養から投与まで一貫した体制で30,000名以上の患者様をサポートしてきました。', 'zh-TW': 'AC Medical Group於2006年在大阪成立，是一家專注於再生醫療的醫療機構，擁有超過18年的實績。在大阪市中央區擁有9層專用大樓「日本細胞大樓」，從培養到投藥提供一貫式服務，已為超過30,000名患者提供支援。', 'zh-CN': 'AC Medical Group于2006年在大阪成立，是一家专注于再生医疗的医疗机构，拥有超过18年的实绩。在大阪市中央区拥有9层专用大楼「日本细胞大楼」，从培养到投药提供一贯式服务，已为超过30,000名患者提供支援。', en: 'Founded in 2006 in Osaka, AC Medical Group is a regenerative medicine institution with over 18 years of track record. Operating from a 9-floor dedicated building, the Japan Cell Building, in Chuo-ku, Osaka, they have supported over 30,000 patients with integrated services from cell cultivation to administration.', ko: 'AC Medical Group은 2006년 오사카에서 설립되어 18년 이상의 실적을 보유한 재생의료 전문 의료기관입니다. 오사카시 주오구에 9층 전용 빌딩 「일본세포빌딩」을 보유하며, 배양부터 투여까지 일관된 체제로 30,000명 이상의 환자를 지원해 왔습니다.' } as Record<Language, string>,
  introP2: { ja: '京都大学再生医療研究所（河本宏チーム、iPS/ES細胞キラーT細胞技術）および大阪大学医学部附属病院と学術連携し、先進的な治療技術を臨床に応用しています。', 'zh-TW': '與京都大學再生醫療研究所（河本宏團隊，iPS/ES細胞殺手T細胞技術）及大阪大學醫學部附屬醫院進行學術合作，將先進的治療技術應用於臨床。', 'zh-CN': '与京都大学再生医疗研究所（河本宏团队，iPS/ES细胞杀手T细胞技术）及大阪大学医学部附属医院进行学术合作，将先进的治疗技术应用于临床。', en: 'In academic partnership with Kyoto University Institute of Regenerative Medicine (Prof. Kawamoto Hiroshi\'s team, iPS/ES cell killer T-cell technology) and Osaka University Medical Hospital, bringing advanced treatment technologies to clinical practice.', ko: '교토대학 재생의료연구소(카와모토 히로시 팀, iPS/ES세포 킬러T세포 기술) 및 오사카대학 의학부 부속병원과 학술 연계하여, 첨단 치료 기술을 임상에 응용하고 있습니다.' } as Record<Language, string>,
  partnerKyoto: { ja: '京都大学再生医療研究所', 'zh-TW': '京都大學再生醫療研究所', 'zh-CN': '京都大学再生医疗研究所', en: 'Kyoto Univ. Institute of Regenerative Medicine', ko: '교토대학 재생의료연구소' } as Record<Language, string>,
  partnerOsaka: { ja: '大阪大学医学部附属病院', 'zh-TW': '大阪大學醫學部附屬醫院', 'zh-CN': '大阪大学医学部附属医院', en: 'Osaka Univ. Medical Hospital', ko: '오사카대학 의학부 부속병원' } as Record<Language, string>,

  // Treatments
  treatTag: { ja: '治療メニュー', 'zh-TW': '治療項目', 'zh-CN': '治疗项目', en: 'Treatment Menu', ko: '치료 메뉴' } as Record<Language, string>,
  treatTitle: { ja: '5つの先端再生医療', 'zh-TW': '5項先端再生醫療', 'zh-CN': '5项先端再生医疗', en: '5 Advanced Regenerative Therapies', ko: '5가지 첨단 재생의료' } as Record<Language, string>,
  viewDetail: { ja: '詳細を見る', 'zh-TW': '查看詳情', 'zh-CN': '查看详情', en: 'View Details', ko: '자세히 보기' } as Record<Language, string>,
  hideDetail: { ja: '閉じる', 'zh-TW': '收起', 'zh-CN': '收起', en: 'Hide', ko: '닫기' } as Record<Language, string>,

  // Treatment 1: Stem Cell
  sc_name: { ja: '自己脂肪由来幹細胞療法', 'zh-TW': '自體脂肪幹細胞療法', 'zh-CN': '自体脂肪干细胞疗法', en: 'Adipose-Derived Stem Cell Therapy', ko: '자가 지방 유래 줄기세포 치료' } as Record<Language, string>,
  sc_desc: { ja: '自己複製能、多分化能、パラクライン効果の3大特性を活かした再生医療の中核治療', 'zh-TW': '運用自我複製能力、多向分化能力、旁分泌效應三大特性的再生醫療核心治療', 'zh-CN': '运用自我复制能力、多向分化能力、旁分泌效应三大特性的再生医疗核心治疗', en: 'Core regenerative therapy utilizing 3 key properties: self-replication, multi-differentiation, and paracrine effects', ko: '자가복제능, 다분화능, 파라크라인 효과의 3대 특성을 활용한 재생의료 핵심 치료' } as Record<Language, string>,
  sc_apps: { ja: '代謝疾患・神経疾患・心血管・消化器・呼吸器・免疫・運動器', 'zh-TW': '代謝疾病・神經疾病・心血管・消化系統・呼吸系統・免疫・運動系統', 'zh-CN': '代谢疾病·神经疾病·心血管·消化系统·呼吸系统·免疫·运动系统', en: 'Metabolic, neurological, cardiovascular, digestive, respiratory, immune, musculoskeletal', ko: '대사질환·신경질환·심혈관·소화기·호흡기·면역·근골격계' } as Record<Language, string>,
  sc_process: { ja: '診断 → 脂肪採取（2mm切開, 20-30ml）→ 4週間培養（約1億個）→ 投与', 'zh-TW': '診斷 → 脂肪採取（2mm切口, 20-30ml）→ 4週培養（約1億個）→ 投與', 'zh-CN': '诊断 → 脂肪采取（2mm切口, 20-30ml）→ 4周培养（约1亿个）→ 投与', en: 'Diagnosis → Fat extraction (2mm incision, 20-30ml) → 4-week cultivation (~100M cells) → Administration', ko: '진단 → 지방 채취(2mm 절개, 20-30ml) → 4주 배양(약 1억 개) → 투여' } as Record<Language, string>,
  sc_preserve: { ja: '-196°Cの液体窒素保存、解凍後回復率90%以上', 'zh-TW': '-196°C液態氮保存，解凍後恢復率90%以上', 'zh-CN': '-196°C液态氮保存，解冻后恢复率90%以上', en: '-196°C liquid nitrogen preservation, >90% post-thaw recovery rate', ko: '-196°C 액체질소 보존, 해동 후 회복률 90% 이상' } as Record<Language, string>,

  // Treatment 2: NK Cell
  nk_name: { ja: 'NK細胞療法', 'zh-TW': 'NK細胞療法', 'zh-CN': 'NK细胞疗法', en: 'NK Cell Therapy', ko: 'NK세포 치료' } as Record<Language, string>,
  nk_desc: { ja: '自然免疫細胞（リンパ球の5-20%）を約1億個まで拡大培養、95%以上の生存率で投与', 'zh-TW': '將自然免疫細胞（淋巴球的5-20%）擴大培養至約1億個，以95%以上的存活率投與', 'zh-CN': '将自然免疫细胞（淋巴细胞的5-20%）扩大培养至约1亿个，以95%以上的存活率投与', en: 'Expand natural immune cells (5-20% of lymphocytes) to ~100M, administered with >95% viability', ko: '자연면역세포(림프구의 5-20%)를 약 1억 개까지 확대 배양, 95% 이상의 생존율로 투여' } as Record<Language, string>,
  nk_targets: { ja: 'がん予防、治療後の再発予防に', 'zh-TW': '用於癌症預防、治療後復發預防', 'zh-CN': '用于癌症预防、治疗后复发预防', en: 'Cancer prevention and post-treatment recurrence prevention', ko: '암 예방, 치료 후 재발 예방' } as Record<Language, string>,
  nk_process: { ja: '評価 → 採血 → 培養 → 点滴投与', 'zh-TW': '評估 → 採血 → 培養 → 點滴投與', 'zh-CN': '评估 → 采血 → 培养 → 点滴投与', en: 'Evaluation → Blood collection → Cultivation → IV infusion', ko: '평가 → 채혈 → 배양 → 점적 투여' } as Record<Language, string>,

  // Treatment 3: Supernatant
  sn_name: { ja: '幹細胞培養上清液', 'zh-TW': '幹細胞培養上清液', 'zh-CN': '干细胞培养上清液', en: 'Stem Cell Supernatant', ko: '줄기세포 배양 상청액' } as Record<Language, string>,
  sn_desc: { ja: '120種以上の成長因子、50種以上のサイトカイン、エクソソームを含む1mLあたり1,000種以上の生理活性物質', 'zh-TW': '含有120種以上成長因子、50種以上細胞因子、外泌體等每mL 1,000種以上生理活性物質', 'zh-CN': '含有120种以上成长因子、50种以上细胞因子、外泌体等每mL 1,000种以上生理活性物质', en: '120+ growth factors, 50+ cytokines, exosomes — 1,000+ bioactive substances per mL', ko: '120종 이상의 성장인자, 50종 이상의 사이토카인, 엑소좀을 포함한 mL당 1,000종 이상의 생리활성물질' } as Record<Language, string>,
  sn_apps: { ja: '運動器・代謝・皮膚/毛髪・自己免疫疾患', 'zh-TW': '運動系統・代謝・皮膚/毛髮・自體免疫疾病', 'zh-CN': '运动系统·代谢·皮肤/毛发·自身免疫疾病', en: 'Musculoskeletal, metabolic, skin/hair, autoimmune', ko: '근골격계·대사·피부/모발·자가면역질환' } as Record<Language, string>,
  sn_admin: { ja: '点滴（30-60分）、注射、マイクロニードル', 'zh-TW': '點滴（30-60分鐘）、注射、微針', 'zh-CN': '点滴（30-60分钟）、注射、微针', en: 'IV (30-60min), injection, or microneedle', ko: '점적(30-60분), 주사, 마이크로니들' } as Record<Language, string>,

  // Treatment 4: ACRS
  acrs_name: { ja: 'ACRS療法', 'zh-TW': 'ACRS療法', 'zh-CN': 'ACRS疗法', en: 'ACRS Therapy', ko: 'ACRS 치료' } as Record<Language, string>,
  acrs_desc: { ja: 'PRP療法の進化版。37°C処理で高濃度の抗炎症サイトカイン（IL-1ra, IL-4ra）を活性化', 'zh-TW': 'PRP療法的進化版。37°C處理激活高濃度抗炎細胞因子（IL-1ra, IL-4ra）', 'zh-CN': 'PRP疗法的进化版。37°C处理激活高浓度抗炎细胞因子（IL-1ra, IL-4ra）', en: 'Evolution of PRP therapy. 37°C processing activates high-concentration anti-inflammatory cytokines (IL-1ra, IL-4ra)', ko: 'PRP 치료의 진화판. 37°C 처리로 고농도 항염증 사이토카인(IL-1ra, IL-4ra)을 활성화' } as Record<Language, string>,
  acrs_apps: { ja: '神経疾患・抗炎症・関節痛・毛髪・顔面若返り', 'zh-TW': '神經疾病・抗炎症・關節痛・毛髮・面部年輕化', 'zh-CN': '神经疾病·抗炎症·关节痛·毛发·面部年轻化', en: 'Neurological, anti-inflammatory, joint pain, hair, facial rejuvenation', ko: '신경질환·항염증·관절통·모발·안면 회춘' } as Record<Language, string>,
  acrs_process: { ja: '採血 → 3時間血液処理 → 血清分離 → 注入 → 経過観察', 'zh-TW': '採血 → 3小時血液處理 → 血清分離 → 注入 → 追蹤觀察', 'zh-CN': '采血 → 3小时血液处理 → 血清分离 → 注入 → 追踪观察', en: 'Blood draw → 3-hour processing → Serum separation → Injection → Follow-up', ko: '채혈 → 3시간 혈액처리 → 혈청분리 → 주입 → 경과관찰' } as Record<Language, string>,

  // Treatment 5: Blood Purification
  bp_name: { ja: '血液浄化療法', 'zh-TW': '血液淨化療法', 'zh-CN': '血液净化疗法', en: 'Blood Purification (Apheresis)', ko: '혈액정화 치료(아페레시스)' } as Record<Language, string>,
  bp_desc: { ja: 'Leocanaフィルターで中性脂肪・LDLコレステロールを選択的に除去。動脈硬化・心筋梗塞・脳卒中を予防', 'zh-TW': '使用Leocana濾器選擇性去除三酸甘油脂・LDL膽固醇。預防動脈硬化・心肌梗塞・腦中風', 'zh-CN': '使用Leocana滤器选择性去除甘油三酯·LDL胆固醇。预防动脉硬化·心肌梗塞·脑卒中', en: 'Selectively removes triglycerides and LDL cholesterol using Leocana filter. Prevents arteriosclerosis, heart attack, stroke', ko: 'Leocana 필터로 중성지방·LDL 콜레스테롤을 선택적으로 제거. 동맥경화·심근경색·뇌졸중 예방' } as Record<Language, string>,

  // Stem Cell Deep Dive
  scDeepTag: { ja: '幹細胞療法 詳解', 'zh-TW': '幹細胞療法 詳解', 'zh-CN': '干细胞疗法 详解', en: 'Stem Cell Therapy In-Depth', ko: '줄기세포 치료 상세' } as Record<Language, string>,
  scDeepTitle: { ja: '幹細胞の3大特性と臨床応用', 'zh-TW': '幹細胞的3大特性與臨床應用', 'zh-CN': '干细胞的3大特性与临床应用', en: '3 Key Stem Cell Properties & Clinical Applications', ko: '줄기세포의 3대 특성과 임상 응용' } as Record<Language, string>,
  prop1: { ja: '自己複製能', 'zh-TW': '自我複製能力', 'zh-CN': '自我复制能力', en: 'Self-Replication', ko: '자가복제능' } as Record<Language, string>,
  prop1d: { ja: '幹細胞が自ら分裂・増殖し、同一の幹細胞を無限に生み出す能力', 'zh-TW': '幹細胞自行分裂增殖，無限生成同一幹細胞的能力', 'zh-CN': '干细胞自行分裂增殖，无限生成同一干细胞的能力', en: 'The ability to divide and proliferate, infinitely generating identical stem cells', ko: '줄기세포가 스스로 분열·증식하여 동일한 줄기세포를 무한히 생성하는 능력' } as Record<Language, string>,
  prop2: { ja: '多分化能', 'zh-TW': '多向分化能力', 'zh-CN': '多向分化能力', en: 'Multi-Differentiation', ko: '다분화능' } as Record<Language, string>,
  prop2d: { ja: '骨、軟骨、脂肪、筋肉、神経など様々な細胞に変化する能力', 'zh-TW': '可分化為骨骼、軟骨、脂肪、肌肉、神經等多種細胞', 'zh-CN': '可分化为骨骼、软骨、脂肪、肌肉、神经等多种细胞', en: 'Transforms into bone, cartilage, fat, muscle, nerve, and other cell types', ko: '뼈, 연골, 지방, 근육, 신경 등 다양한 세포로 변화하는 능력' } as Record<Language, string>,
  prop3: { ja: 'パラクライン効果', 'zh-TW': '旁分泌效應', 'zh-CN': '旁分泌效应', en: 'Paracrine Effect', ko: '파라크라인 효과' } as Record<Language, string>,
  prop3d: { ja: '成長因子やサイトカインを放出し、周囲の細胞を修復・活性化する効果', 'zh-TW': '釋放成長因子和細胞因子，修復並活化周圍細胞', 'zh-CN': '释放成长因子和细胞因子，修复并活化周围细胞', en: 'Releases growth factors and cytokines to repair and activate surrounding cells', ko: '성장인자와 사이토카인을 방출하여 주변 세포를 수복·활성화하는 효과' } as Record<Language, string>,
  clinicalApps: { ja: '臨床応用分野', 'zh-TW': '臨床應用領域', 'zh-CN': '临床应用领域', en: 'Clinical Application Areas', ko: '임상 응용 분야' } as Record<Language, string>,
  processTitle: { ja: '治療プロセス', 'zh-TW': '治療流程', 'zh-CN': '治疗流程', en: 'Treatment Process', ko: '치료 프로세스' } as Record<Language, string>,

  // CPC
  cpcTag: { ja: '細胞培養加工施設', 'zh-TW': '細胞培養加工設施', 'zh-CN': '细胞培养加工设施', en: 'Cell Processing Center', ko: '세포배양가공시설' } as Record<Language, string>,
  cpcTitle: { ja: 'ISO Class 5 クリーンルーム', 'zh-TW': 'ISO Class 5 無塵室', 'zh-CN': 'ISO Class 5 洁净室', en: 'ISO Class 5 Cleanroom', ko: 'ISO Class 5 클린룸' } as Record<Language, string>,
  cpcDesc: { ja: '7階に設置された細胞培養加工施設（CPC）は、ISO Class 5（Class 100）の清浄度を維持。-85°C超低温フリーザーと-196°C液体窒素タンクで細胞を厳密に管理。GMP準拠のモニタリングシステムで24時間監視しています。', 'zh-TW': '位於7樓的細胞培養加工設施（CPC）維持ISO Class 5（Class 100）的潔淨度。使用-85°C超低溫冷凍庫和-196°C液態氮儲存槽嚴格管理細胞。符合GMP的監控系統24小時監控。', 'zh-CN': '位于7楼的细胞培养加工设施（CPC）维持ISO Class 5（Class 100）的洁净度。使用-85°C超低温冷冻库和-196°C液态氮储存罐严格管理细胞。符合GMP的监控系统24小时监控。', en: 'The Cell Processing Center (CPC) on the 7th floor maintains ISO Class 5 (Class 100) cleanliness. Cells are strictly managed with -85°C ultra-low temperature freezers and -196°C liquid nitrogen tanks, monitored 24/7 by GMP-compliant systems.', ko: '7층에 설치된 세포배양가공시설(CPC)은 ISO Class 5(Class 100) 청정도를 유지합니다. -85°C 초저온 냉동고와 -196°C 액체질소 탱크로 세포를 엄격히 관리하며, GMP 준수 모니터링 시스템으로 24시간 감시하고 있습니다.' } as Record<Language, string>,

  // Building
  bldgTag: { ja: '施設案内', 'zh-TW': '設施導覽', 'zh-CN': '设施导览', en: 'Facility Guide', ko: '시설 안내' } as Record<Language, string>,
  bldgTitle: { ja: '日本細胞ビル — 9階建て専用施設', 'zh-TW': '日本細胞大樓 — 9層專用設施', 'zh-CN': '日本细胞大楼 — 9层专用设施', en: 'Japan Cell Building — 9-Floor Dedicated Facility', ko: '일본세포빌딩 — 9층 전용 시설' } as Record<Language, string>,
  bldgSub: { ja: '再生医療に特化した9階建て専用ビル', 'zh-TW': '專注再生醫療的9層專用大樓', 'zh-CN': '专注再生医疗的9层专用大楼', en: '9-floor building dedicated to regenerative medicine', ko: '재생의료에 특화된 9층 전용 빌딩' } as Record<Language, string>,

  // Features
  featTag: { ja: 'ACセルクリニックの特徴', 'zh-TW': 'AC Cell Clinic的特色', 'zh-CN': 'AC Cell Clinic的特色', en: 'AC Cell Clinic Features', ko: 'AC Cell Clinic의 특징' } as Record<Language, string>,
  feat1Title: { ja: '産学連携の研究チーム', 'zh-TW': '產學合作的研究團隊', 'zh-CN': '产学合作的研究团队', en: 'Industry-Academic Research Team', ko: '산학연계 연구팀' } as Record<Language, string>,
  feat1Desc: { ja: '京都大学再生医療研究所（河本宏チーム）と大阪大学医学部附属病院との学術連携により、iPS/ES細胞キラーT細胞技術をはじめとする先端研究を臨床応用しています。', 'zh-TW': '與京都大學再生醫療研究所（河本宏團隊）和大阪大學醫學部附屬醫院學術合作，將iPS/ES細胞殺手T細胞技術等先端研究應用於臨床。', 'zh-CN': '与京都大学再生医疗研究所（河本宏团队）和大阪大学医学部附属医院学术合作，将iPS/ES细胞杀手T细胞技术等先端研究应用于临床。', en: 'Academic partnerships with Kyoto University (Prof. Kawamoto team) and Osaka University Hospital bring advanced iPS/ES cell killer T-cell technology to clinical practice.', ko: '교토대학 재생의료연구소(가와모토 팀)와 오사카대학 의학부 부속병원과의 학술 제휴를 통해 iPS/ES 세포 킬러 T세포 기술 등 첨단 연구를 임상에 응용하고 있습니다.' } as Record<Language, string>,
  feat2Title: { ja: '安全性・有効性の追求', 'zh-TW': '追求安全性與有效性', 'zh-CN': '追求安全性与有效性', en: 'Pursuit of Safety & Efficacy', ko: '안전성·유효성 추구' } as Record<Language, string>,
  feat2Desc: { ja: '自院CPC（ISO Class 5）での一貫した品質管理、30,000名以上の治療実績、98%以上の患者満足度が証明する信頼性。-196°C液体窒素保存で解凍後回復率90%以上。', 'zh-TW': '院內CPC（ISO Class 5）的一貫品質管理，超過30,000名治療實績，98%以上患者滿意度所證明的可靠性。-196°C液態氮保存，解凍後恢復率超過90%。', 'zh-CN': '院内CPC（ISO Class 5）的一贯品质管理，超过30,000名治疗实绩，98%以上患者满意度所证明的可靠性。-196°C液态氮保存，解冻后恢复率超过90%。', en: 'Consistent quality control in our in-house CPC (ISO Class 5), proven by 30,000+ treatments and 98%+ patient satisfaction. >90% post-thaw recovery with -196°C liquid nitrogen storage.', ko: '자체 CPC(ISO Class 5)에서의 일관된 품질 관리, 30,000명 이상의 치료 실적, 98% 이상의 환자 만족도가 증명하는 신뢰성. -196°C 액체질소 보존으로 해동 후 회복률 90% 이상.' } as Record<Language, string>,
  feat3Title: { ja: '国際対応サービス', 'zh-TW': '國際服務', 'zh-CN': '国际服务', en: 'International Service', ko: '국제 대응 서비스' } as Record<Language, string>,
  feat3Desc: { ja: '中国語・英語の翻訳サポート完備。国際患者専用の対応チームが、予約から治療完了までサポート。細胞培養には最低6週間の事前予約が必要です。', 'zh-TW': '提供中文・英文翻譯支援。國際患者專屬團隊從預約到治療完成全程服務。細胞培養需至少提前6週預約。', 'zh-CN': '提供中文·英文翻译支援。国际患者专属团队从预约到治疗完成全程服务。细胞培养需至少提前6周预约。', en: 'Chinese and English translation support available. Dedicated international patient team provides full support from booking to treatment completion. Minimum 6 weeks advance booking required for cell cultivation.', ko: '중국어·영어 번역 지원 완비. 국제 환자 전용 대응팀이 예약부터 치료 완료까지 지원합니다. 세포 배양에는 최소 6주 전 사전 예약이 필요합니다.' } as Record<Language, string>,

  // History
  histTag: { ja: '沿革', 'zh-TW': '沿革', 'zh-CN': '沿革', en: 'History', ko: '연혁' } as Record<Language, string>,
  histTitle: { ja: 'ACメディカルグループの歩み', 'zh-TW': 'AC Medical Group的歷程', 'zh-CN': 'AC Medical Group的历程', en: 'AC Medical Group History', ko: 'AC Medical Group의 발자취' } as Record<Language, string>,
  hist2006: { ja: 'ACメディカルグループ設立。再生医療分野に参入', 'zh-TW': 'AC Medical Group成立。進入再生醫療領域', 'zh-CN': 'AC Medical Group成立。进入再生医疗领域', en: 'AC Medical Group founded. Entered regenerative medicine field', ko: 'AC Medical Group 설립. 재생의료 분야 진출' } as Record<Language, string>,
  hist2018: { ja: '累計患者数10,000名を突破', 'zh-TW': '累計患者數突破10,000名', 'zh-CN': '累计患者数突破10,000名', en: 'Surpassed 10,000 cumulative patients', ko: '누적 환자 수 10,000명 돌파' } as Record<Language, string>,
  hist2020: { ja: '日本細胞ビルに移転。9階建て専用施設での運営開始', 'zh-TW': '搬遷至日本細胞大樓。開始在9層專用設施運營', 'zh-CN': '搬迁至日本细胞大楼。开始在9层专用设施运营', en: 'Relocated to Japan Cell Building. Operations began in 9-floor dedicated facility', ko: '일본세포빌딩으로 이전. 9층 전용 시설에서 운영 개시' } as Record<Language, string>,
  hist2024: { ja: '累計患者数30,000名突破。2024年大幅アップグレード完了', 'zh-TW': '累計患者數突破30,000名。2024年大幅升級完成', 'zh-CN': '累计患者数突破30,000名。2024年大幅升级完成', en: 'Surpassed 30,000 patients. Major 2024 facility upgrade completed', ko: '누적 환자 수 30,000명 돌파. 2024년 대규모 업그레이드 완료' } as Record<Language, string>,

  // Conditions
  condTag: { ja: '対応疾患', 'zh-TW': '適應症', 'zh-CN': '适应症', en: 'Applicable Conditions', ko: '대응 질환' } as Record<Language, string>,
  condTitle: { ja: '幅広い疾患・症状に対応', 'zh-TW': '適用於多種疾病與症狀', 'zh-CN': '适用于多种疾病与症状', en: 'Wide Range of Conditions Treated', ko: '폭넓은 질환·증상에 대응' } as Record<Language, string>,

  // Access
  accessTag: { ja: 'アクセス', 'zh-TW': '交通指南', 'zh-CN': '交通指南', en: 'Access', ko: '오시는 길' } as Record<Language, string>,
  accessTitle: { ja: '大阪・日本細胞ビル', 'zh-TW': '大阪・日本細胞大樓', 'zh-CN': '大阪·日本细胞大楼', en: 'Osaka, Japan Cell Building', ko: '오사카·일본세포빌딩' } as Record<Language, string>,
  address: { ja: '大阪府大阪市中央区北久宝寺町2丁目1-3 日本細胞ビル', 'zh-TW': '大阪府大阪市中央區北久寶寺町2丁目1-3 日本細胞大樓', 'zh-CN': '大阪府大阪市中央区北久宝寺町2丁目1-3 日本细胞大楼', en: '2-1-3 Kitakyuhojimachi, Chuo-ku, Osaka, Japan Cell Building', ko: '오사카부 오사카시 주오구 기타큐호지마치 2쵸메 1-3 일본세포빌딩' } as Record<Language, string>,
  hours: { ja: '10:00〜19:00（完全予約制）', 'zh-TW': '10:00〜19:00（完全預約制）', 'zh-CN': '10:00〜19:00（完全预约制）', en: '10:00-19:00 (Appointment only)', ko: '10:00-19:00 (완전 예약제)' } as Record<Language, string>,
  closed: { ja: '不定休', 'zh-TW': '不定休', 'zh-CN': '不定休', en: 'Irregular holidays', ko: '부정기 휴진' } as Record<Language, string>,
  selfPay: { ja: '自由診療（保険適用外）', 'zh-TW': '自由診療（不適用保險）', 'zh-CN': '自由诊疗（不适用保险）', en: 'Self-pay only (not covered by insurance)', ko: '자유진료 (보험 적용 외)' } as Record<Language, string>,
  ...
  ctaSub: { ja: '再生医療に関するご相談は、専門スタッフが丁寧にご対応いたします', 'zh-TW': '關於再生醫療的諮詢，由專業人員為您細心解答', 'zh-CN': '关于再生医疗的咨询，由专业人员为您细心解答', en: 'Our specialists will carefully guide you through your regenerative medicine options', ko: '재생의료에 관한 상담은 전문 스태프가 정성껏 대응해 드립니다' } as Record<Language, string>,
  ctaChinese: { ja: '中国語対応可能', 'zh-TW': '支援中文服務', 'zh-CN': '支持中文服务', en: 'Chinese Support Available', ko: '중국어 대응 가능' } as Record<Language, string>,
  ctaBooking: { ja: '※ 細胞培養には最低6週間前の事前予約が必要です', 'zh-TW': '※ 細胞培養需至少提前6週預約', 'zh-CN': '※ 细胞培养需至少提前6周预约', en: '※ Minimum 6 weeks advance booking required for cell cultivation', ko: '※ 세포 배양에는 최소 6주 전 사전 예약이 필요합니다' } as Record<Language, string>,
};

// FAQ data
const faqData: { q: Record<Language, string>; a: Record<Language, string> }[] = [
  {
    q: { ja: 'なぜ日本の再生医療が選ばれるのですか？', 'zh-TW': '為什麼選擇日本的再生醫療？', 'zh-CN': '为什么选择日本的再生医疗？', en: 'Why choose Japan for regenerative medicine?', ko: '왜 일본의 재생의료를 선택하나요?' },
    a: { ja: '日本は再生医療分野で4,000件以上の臨床研究、3,600件以上の特許を保有し、世界で初めて再生医療に関する法律（再生医療等安全性確保法）を制定した国です。法的枠組みの整備により、安全かつ効果的な治療を受けることができます。', 'zh-TW': '日本在再生醫療領域擁有4,000多項臨床研究、3,600多項專利，是世界上第一個制定再生醫療法律（再生醫療等安全確保法）的國家。完善的法律框架確保您能接受安全有效的治療。', 'zh-CN': '日本在再生医疗领域拥有4,000多项临床研究、3,600多项专利，是世界上第一个制定再生医疗法律（再生医疗等安全确保法）的国家。完善的法律框架确保您能接受安全有效的治疗。', en: 'Japan has 4,000+ clinical studies, 3,600+ patents in regenerative medicine, and was the first country to enact a law specifically for regenerative medicine safety. This legal framework ensures safe and effective treatment.', ko: '일본은 재생의료 분야에서 4,000건 이상의 임상연구, 3,600건 이상의 특허를 보유하고 있으며, 세계 최초로 재생의료에 관한 법률(재생의료 등 안전성 확보법)을 제정한 나라입니다. 법적 체계의 정비로 안전하고 효과적인 치료를 받을 수 있습니다.' },
  },
  {
    q: { ja: '治療前にどのような検査が必要ですか？', 'zh-TW': '治療前需要哪些檢查？', 'zh-CN': '治疗前需要哪些检查？', en: 'What tests are required before treatment?', ko: '치료 전 어떤 검사가 필요합니까?' },
    a: { ja: '血液検査、腫瘍マーカー、感染症スクリーニング（HIV、HBV、HCV、梅毒など）が必要です。国内外の医療機関での検査結果（3ヶ月以内）を事前にご提出いただきます。', 'zh-TW': '需要血液檢查、腫瘤標記物、感染症篩檢（HIV、HBV、HCV、梅毒等）。請事先提交國內外醫療機構的檢查結果（3個月以內）。', 'zh-CN': '需要血液检查、肿瘤标记物、感染症筛检（HIV、HBV、HCV、梅毒等）。请事先提交国内外医疗机构的检查结果（3个月以内）。', en: 'Blood tests, tumor markers, and infection screening (HIV, HBV, HCV, syphilis, etc.) are required. Please submit test results from medical institutions (within 3 months) in advance.', ko: '혈액검사, 종양표지자, 감염증 스크리닝(HIV, HBV, HCV, 매독 등)이 필요합니다. 국내외 의료기관의 검사 결과(3개월 이내)를 사전에 제출해 주십시오.' },
  },
  {
    q: { ja: 'がん患者も治療を受けられますか？', 'zh-TW': '癌症患者也能接受治療嗎？', 'zh-CN': '癌症患者也能接受治疗吗？', en: 'Can cancer patients receive treatment?', ko: '암 환자도 치료를 받을 수 있습니까?' },
    a: { ja: '活動性のがん（進行中）は幹細胞療法の禁忌となります。ただし、安定期または寛解状態のがん患者様は、医師の判断により治療可能な場合があります。NK細胞療法はがん予防・再発予防にご利用いただけます。', 'zh-TW': '活動性癌症（進行中）是幹細胞療法的禁忌症。但處於穩定期或緩解狀態的癌症患者，經醫師判斷後可能可以接受治療。NK細胞療法可用於癌症預防和復發預防。', 'zh-CN': '活动性癌症（进行中）是干细胞疗法的禁忌症。但处于稳定期或缓解状态的癌症患者，经医师判断后可能可以接受治疗。NK细胞疗法可用于癌症预防和复发预防。', en: 'Active (progressing) cancer is a contraindication for stem cell therapy. However, patients in stable or remission status may qualify upon physician evaluation. NK cell therapy is available for cancer prevention and recurrence prevention.', ko: '활동성 암(진행 중)은 줄기세포 치료의 금기입니다. 다만, 안정기 또는 관해 상태의 암 환자는 의사의 판단에 따라 치료가 가능할 수 있습니다. NK세포 치료는 암 예방·재발 예방에 이용하실 수 있습니다.' },
  },
  {
    q: { ja: '脂肪採取はどのように行いますか？', 'zh-TW': '脂肪採取如何進行？', 'zh-CN': '脂肪采取如何进行？', en: 'How is fat extraction performed?', ko: '지방 채취는 어떻게 진행됩니까?' },
    a: { ja: '最新の1mmマイクロニードル技術を使用し、0.05MPaの超低圧で約10分間で採取します。傷跡は目立たず、日帰りで施術可能です。従来の方法に比べて痛みが大幅に軽減されています。', 'zh-TW': '使用最新的1mm微針技術，以0.05MPa超低壓在約10分鐘內完成採取。傷口不明顯，可當日完成手術。比傳統方法大幅減輕疼痛。', 'zh-CN': '使用最新的1mm微针技术，以0.05MPa超低压在约10分钟内完成采取。伤口不明显，可当日完成手术。比传统方法大幅减轻疼痛。', en: 'Using the latest 1mm microneedle technology at 0.05MPa ultra-low pressure, extraction takes about 10 minutes. Scars are minimal, and it\'s a same-day procedure with significantly reduced pain compared to traditional methods.', ko: '최신 1mm 마이크로니들 기술을 사용하여 0.05MPa 초저압으로 약 10분 만에 채취합니다. 흉터가 거의 남지 않으며, 당일 시술이 가능합니다. 기존 방법에 비해 통증이 크게 경감되었습니다.' },
  },
  {
    q: { ja: '投与された細胞はどのくらい体内で作用しますか？', 'zh-TW': '投與的細胞在體內作用多久？', 'zh-CN': '投与的细胞在体内作用多久？', en: 'How long do administered cells work in the body?', ko: '투여된 세포는 체내에서 얼마나 작용합니까?' },
    a: { ja: '投与後1〜3ヶ月で活性化期、3〜6ヶ月で修復期、6〜9ヶ月で若返り期と段階的に効果が現れます。個人差はありますが、多くの患者様が3ヶ月目頃から変化を実感されます。', 'zh-TW': '投與後1-3個月為活化期，3-6個月為修復期，6-9個月為年輕化期，效果分階段顯現。雖有個人差異，但多數患者在3個月左右開始感受到變化。', 'zh-CN': '投与后1-3个月为活化期，3-6个月为修复期，6-9个月为年轻化期，效果分阶段显现。虽有个人差异，但多数患者在3个月左右开始感受到变化。', en: 'Effects appear in stages: 1-3 months activation, 3-6 months repair, 6-9 months rejuvenation. While individual results vary, most patients notice changes around the 3-month mark.', ko: '투여 후 1-3개월은 활성화기, 3-6개월은 수복기, 6-9개월은 회춘기로 단계적으로 효과가 나타납니다. 개인차가 있지만, 많은 환자가 3개월경부터 변화를 실감합니다.' },
  },
  {
    q: { ja: '治療頻度はどのくらいですか？', 'zh-TW': '治療頻率是多少？', 'zh-CN': '治疗频率是多少？', en: 'How often should I receive treatment?', ko: '치료 빈도는 어느 정도입니까?' },
    a: { ja: '個々の症状や目的に応じて、医師が最適な治療プランを策定します。初回治療後の経過を見ながら、追加治療の必要性を判断いたします。', 'zh-TW': '根據個人症狀和目的，醫師會制定最佳治療計劃。觀察初次治療後的進展，判斷是否需要追加治療。', 'zh-CN': '根据个人症状和目的，医师会制定最佳治疗计划。观察初次治疗后的进展，判断是否需要追加治疗。', en: 'Your physician will create a personalized treatment plan based on your symptoms and goals. Additional treatment needs are assessed based on progress after the initial treatment.', ko: '개별 증상과 목적에 따라 의사가 최적의 치료 계획을 수립합니다. 초회 치료 후 경과를 보면서 추가 치료의 필요성을 판단합니다.' },
  },
  {
    q: { ja: '治療後の注意事項はありますか？', 'zh-TW': '治療後有什麼注意事項？', 'zh-CN': '治疗后有什么注意事项？', en: 'Are there post-treatment precautions?', ko: '치료 후 주의사항이 있습니까?' },
    a: { ja: '治療後は十分な休息を取り、激しい運動は数日間お控えください。また、治療後1ヶ月間はワクチン接種をお避けください。日常生活は通常通りお過ごしいただけます。', 'zh-TW': '治療後請充分休息，數日內避免劇烈運動。治療後1個月內請避免接種疫苗。日常生活可正常進行。', 'zh-CN': '治疗后请充分休息，数日内避免剧烈运动。治疗后1个月内请避免接种疫苗。日常生活可正常进行。', en: 'Rest well after treatment and avoid strenuous activity for several days. Avoid vaccinations for 1 month after treatment. Daily activities can continue as normal.', ko: '치료 후 충분한 휴식을 취하시고, 수일간 격렬한 운동은 삼가주십시오. 또한 치료 후 1개월간은 예방접종을 피해주십시오. 일상생활은 평소대로 하실 수 있습니다.' },
  },
  {
    q: { ja: '予約はどのくらい前に必要ですか？', 'zh-TW': '需要提前多久預約？', 'zh-CN': '需要提前多久预约？', en: 'How far in advance should I book?', ko: '얼마나 전에 예약해야 합니까?' },
    a: { ja: '細胞培養に最低4〜6週間必要なため、治療の最低6週間前までにご予約ください。渡航準備も含めると、2〜3ヶ月前のご相談をお勧めいたします。', 'zh-TW': '由於細胞培養至少需要4-6週，請在治療前至少6週預約。考慮到出行準備，建議提前2-3個月諮詢。', 'zh-CN': '由于细胞培养至少需要4-6周，请在治疗前至少6周预约。考虑到出行准备，建议提前2-3个月咨询。', en: 'Cell cultivation requires a minimum of 4-6 weeks, so please book at least 6 weeks before treatment. We recommend consulting 2-3 months in advance to allow for travel preparations.', ko: '세포 배양에 최소 4-6주가 필요하므로, 치료 최소 6주 전까지 예약해 주십시오. 도항 준비를 포함하면 2-3개월 전 상담을 권장합니다.' },
  },
  {
    q: { ja: '保険は適用されますか？', 'zh-TW': '可以使用保險嗎？', 'zh-CN': '可以使用保险吗？', en: 'Is insurance applicable?', ko: '보험이 적용됩니까?' },
    a: { ja: '当クリニックの再生医療はすべて自由診療（保険適用外）となります。治療費用については、初回カウンセリング時に詳しくご案内いたします。', 'zh-TW': '本診所的再生醫療全部為自由診療（不適用保險）。治療費用將在初次諮詢時詳細說明。', 'zh-CN': '本诊所的再生医疗全部为自由诊疗（不适用保险）。治疗费用将在初次咨询时详细说明。', en: 'All regenerative medicine treatments at our clinic are self-pay (not covered by insurance). Treatment costs will be explained in detail during your initial consultation.', ko: '당 클리닉의 재생의료는 모두 자유진료(보험 적용 외)입니다. 치료 비용은 초회 상담 시 자세히 안내해 드립니다.' },
  },
];

// Building floors
const floors: { floor: string; label: Record<Language, string>; icon: React.ReactNode }[] = [
  { floor: '9F', label: { ja: '本部オフィス', 'zh-TW': '總部辦公室', 'zh-CN': '总部办公室', en: 'Headquarters', ko: '본부 오피스' }, icon: <Building2 size={16} /> },
  { floor: '8F', label: { ja: '会議室', 'zh-TW': '會議室', 'zh-CN': '会议室', en: 'Conference Room', ko: '회의실' }, icon: <Users size={16} /> },
  { floor: '7F', label: { ja: 'CPC（ISO Class 5）', 'zh-TW': 'CPC（ISO Class 5）', 'zh-CN': 'CPC（ISO Class 5）', en: 'CPC (ISO Class 5)', ko: 'CPC(ISO Class 5)' }, icon: <Microscope size={16} /> },
  { floor: '6F', label: { ja: '管理部門', 'zh-TW': '行政管理', 'zh-CN': '行政管理', en: 'Administration', ko: '투여' }, icon: <Building size={16} /> },
  { floor: '5F', label: { ja: '受付・カウンセリング', 'zh-TW': '接待・諮詢', 'zh-CN': '接待·咨询', en: 'Reception & Counseling', ko: '접수·상담' }, icon: <Stethoscope size={16} /> },
  { floor: '4F', label: { ja: '治療室', 'zh-TW': '治療室', 'zh-CN': '治疗室', en: 'Treatment Rooms', ko: '치료실' }, icon: <Syringe size={16} /> },
  { floor: '3F', label: { ja: 'VIPルーム', 'zh-TW': 'VIP室', 'zh-CN': 'VIP室', en: 'VIP Rooms', ko: 'VIP 룸' }, icon: <Star size={16} /> },
  { floor: '2F', label: { ja: 'ピラティススタジオ', 'zh-TW': '皮拉提斯教室', 'zh-CN': '普拉提工作室', en: 'Pilates Studio', ko: '필라테스 스튜디오' }, icon: <Activity size={16} /> },
  { floor: '1F', label: { ja: 'コーヒーショップ', 'zh-TW': '咖啡廳', 'zh-CN': '咖啡厅', en: 'Coffee Shop', ko: '커피숍' }, icon: <Leaf size={16} /> },
];
...
const conditionTags: Record<Language, string[]> = {
  ...
  ko: ['당뇨병', '고혈압', '이상지질혈증', '알츠하이머', '파킨슨병', '뇌졸중 후유증', '심근경색', '동맥경화', '간경변', '만성간염', 'COPD', '간질성 폐렴', '류마티즘', 'SLE', '퇴행성 관절염', '요통', '암 예방', '재발 예방', '안티에이징', '탈모·AGA', 'ED', '아토피 피부염', '만성피로'],
};

// Clinical application areas for stem cell
const clinicalAreas: { icon: React.ReactNode; label: Record<Language, string> }[] = [
  { icon: <Thermometer size={18} />, label: { ja: '代謝疾患', 'zh-TW': '代謝疾病', 'zh-CN': '代谢疾病', en: 'Metabolic', ko: '대사질환' } },
  { icon: <Brain size={18} />, label: { ja: '神経疾患', 'zh-TW': '神經疾病', 'zh-CN': '神经疾病', en: 'Neurological', ko: '신경질환' } },
  { icon: <Heart size={18} />, label: { ja: '心血管', 'zh-TW': '心血管', 'zh-CN': '心血管', en: 'Cardiovascular', ko: '심혈관' } },
  { icon: <Stethoscope size={18} />, label: { ja: '消化器', 'zh-TW': '消化系統', 'zh-CN': '消化系统', en: 'Digestive', ko: '소화기' } },
  { icon: <Activity size={18} />, label: { ja: '呼吸器', 'zh-TW': '呼吸系統', 'zh-CN': '呼吸系统', en: 'Respiratory', ko: '호흡기' } },
  { icon: <Shield size={18} />, label: { ja: '免疫', 'zh-TW': '免疫', 'zh-CN': '免疫', en: 'Immune', ko: '면역' } },
  { icon: <Bone size={18} />, label: { ja: '運動器', 'zh-TW': '運動系統', 'zh-CN': '运动系统', en: 'Musculoskeletal', ko: '근골격계' } },
];
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="bg-[#f6f6f6] rounded-2xl p-8">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4">
              {[
                { icon: <Eye size={24} />, label: { ja: '診断', 'zh-TW': '診斷', 'zh-CN': '诊断', en: 'Diagnosis', ko: '진단' } as Record<Language, string> },
                { icon: <Syringe size={24} />, label: { ja: '脂肪採取\n(2mm, 20-30ml)', 'zh-TW': '脂肪採取\n(2mm, 20-30ml)', 'zh-CN': '脂肪采取\n(2mm, 20-30ml)', en: 'Fat Extraction\n(2mm, 20-30ml)', ko: '지방 채취\n(2mm, 20-30ml)' } as Record<Language, string> },
                { icon: <Microscope size={24} />, label: { ja: '4週間培養\n(約1億個)', 'zh-TW': '4週培養\n(約1億個)', 'zh-CN': '4周培养\n(约1亿个)', en: '4-Week Culture\n(~100M cells)', ko: '4주간 배양\n(약 1억 개)' } as Record<Language, string> },
                { icon: <Droplets size={24} />, label: { ja: '投与', 'zh-TW': '投與', 'zh-CN': '投与', en: 'Administration', ko: '투여' } as Record<Language, string> },
              ].map((step, i, arr) => (
