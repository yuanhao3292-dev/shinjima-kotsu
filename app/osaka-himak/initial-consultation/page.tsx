...
const pageTranslations = {
  serviceName: { ja: '大阪重粒子線センター 初期相談サービス', 'zh-TW': '大阪重粒子線中心 前期諮詢服務', 'zh-CN': '大阪重粒子線中心 前期咨询服务', en: '大阪重粒子線中心 Initial Consultation' } as Record<Language, string>,
  serviceNameEn: { ja: '大阪重粒子線中心 - Initial Consultation', 'zh-TW': '大阪重粒子線中心 - Initial Consultation', 'zh-CN': '大阪重粒子線中心 - Initial Consultation', en: '大阪重粒子線中心 - Initial Consultation' } as Record<Language, string>,
  serviceDescription: { ja: '病歴翻訳・クリニック相談・重粒子線治療プラン評価・費用概算', 'zh-TW': '病歷翻譯、診所諮詢、重粒子線治療方案評估、費用概算', 'zh-CN': '病历翻译、诊所咨询、再生医疗方案评估、费用概算', en: 'Medical record translation, clinic consultation, heavy ion therapy assessment, cost estimate' } as Record<Language, string>,
  serviceLongDescription: { ja: '大阪重粒子線センター向けの初期相談サービス。診療情報を翻訳（中→日）し、クリニックと初期相談を行い、重粒子線治療の可能性を評価し、費用概算をご提供します。', 'zh-TW': '專為大阪重粒子線中心提供的前期諮詢服務。我們將翻譯您的病歷資料（中→日），並與大阪重粒子線中心進行初步諮詢，評估重粒子線治療可行性並提供費用概算。', 'zh-CN': '专为大阪重粒子線中心提供的前期咨询服务。我们将翻译您的病历资料（中→日），并与大阪重粒子線中心进行初步咨询，评估再生医疗可行性并提供费用概算。', en: 'Initial consultation for 大阪重粒子線中心. We translate your medical records (CN→JP), consult with the clinic, assess heavy ion therapy feasibility and provide cost estimates.' } as Record<Language, string>,
  ...
  feature2: { ja: '大阪重粒子線センターへの初期相談', 'zh-TW': '大阪重粒子線中心初步諮詢', 'zh-CN': '大阪重粒子線中心初步咨询', en: 'Initial consultation with 大阪重粒子線中心' } as Record<Language, string>,
  feature3: { ja: '重粒子線治療可能性評価レポート', 'zh-TW': '重粒子線治療可行性評估報告', 'zh-CN': '再生医疗可行性评估报告', en: 'Regenerative medicine feasibility assessment' } as Record<Language, string>,
...
const SERVICE_INFO = {
  id: MEDICAL_PACKAGES['osaka-himak-initial-consultation'].slug,
  slug: MEDICAL_PACKAGES['osaka-himak-initial-consultation'].slug,
  price: MEDICAL_PACKAGES['osaka-himak-initial-consultation'].priceJpy,
};
...
export default function ACPlusInitialConsultationPage() {
  ...
  const backHref = fromParam || (guideSlug ? `/g/${guideSlug}/osaka-himak` : '/osaka-himak');
