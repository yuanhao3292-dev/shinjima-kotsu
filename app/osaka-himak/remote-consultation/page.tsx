...
const pageTranslations = {
  serviceName: { ja: '大阪重粒子線センター 遠隔診療サービス', 'zh-TW': '大阪重粒子線中心 遠程診斷服務', 'zh-CN': '大阪重粒子線中心 远程诊断服务', en: '大阪重粒子線中心 Remote Consultation' } as Record<Language, string>,
  ...
  feature1: { ja: '大阪重粒子線センター専門医とのビデオ診察（約30-60分）', 'zh-TW': '大阪重粒子線中心專科醫生視頻會診（約30-60分鐘）', 'zh-CN': '大阪重粒子線中心专科医生视频会诊（约30-60分钟）', en: 'Video consultation with 大阪重粒子線中心 specialist (30-60 mins)' } as Record<Language, string>,
  ...
  feature3: { ja: '重粒子線治療の適応性評価', 'zh-TW': '重粒子線治療適用性評估', 'zh-CN': '再生医疗适用性评估', en: 'Regenerative medicine suitability assessment' } as Record<Language, string>,
...
const SERVICE_INFO = {
  id: MEDICAL_PACKAGES['osaka-himak-remote-consultation'].slug,
  slug: MEDICAL_PACKAGES['osaka-himak-remote-consultation'].slug,
  price: MEDICAL_PACKAGES['osaka-himak-remote-consultation'].priceJpy,
};
...
export default function ACPlusRemoteConsultationPage() {
  ...
  const backHref = guideSlug ? `/g/${guideSlug}/osaka-himak` : '/osaka-himak';
