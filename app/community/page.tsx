...
const T: Record<string, Record<Language, string>> = {
  ...
  experience: { ja: '体験談', 'zh-CN': '体验分享', 'zh-TW': '體驗分享', en: 'Experience' },
  tip: { ja: 'ヒント', 'zh-CN': '健康贴士', 'zh-TW': '健康貼士', en: 'Health Tip' },
  question: { ja: '質問', 'zh-CN': '提问', 'zh-TW': '提問', en: 'Question' },
  review: { ja: 'レビュー', 'zh-CN': '评价', 'zh-TW': '評價', en: 'Review' },
  all: { ja: 'すべて', 'zh-CN': '全部', 'zh-TW': '全部', en: 'All' },
  helpful: { ja: '参考になった', 'zh-CN': '有帮助', 'zh-TW': '有幫助', en: 'Helpful' },
  views: { ja: '閲覧', 'zh-CN': '浏览', 'zh-TW': '瀏覽', en: 'views' },
  shareStory: { ja: '体験をシェア', 'zh-CN': '分享故事', 'zh-TW': '分享故事', en: 'Share Your Story' },
  noStories: { ja: 'まだ投稿がありません', 'zh-CN': '暂无投稿', 'zh-TW': '暫無投稿', en: 'No stories yet' },
  loadMore: { ja: 'もっと見る', 'zh-CN': '加载更多', 'zh-TW': '載入更多', en: 'Load More' },
  loading: { ja: '読み込み中...', 'zh-CN': '载入中...', 'zh-TW': '載入中...', en: 'Loading...' },
  anonymous: { ja: '匿名ユーザー', 'zh-CN': '匿名用户', 'zh-TW': '匿名用戶', en: 'Anonymous' },
  back: { ja: 'ホームに戻る', 'zh-CN': '返回首页', 'zh-TW': '返回首頁', en: 'Back to Home' },
};
