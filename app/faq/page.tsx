          ...
          <div id="faq-contact" className="mt-16 border border-neutral-200 p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-brand-700 hover:bg-brand-800 text-white px-6 py-3 text-sm font-medium tracking-wider transition-colors"
              >
