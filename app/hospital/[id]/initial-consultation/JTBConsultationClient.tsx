    ...
    <CheckoutLayout>
      ...
      <div className="bg-white border-b border-neutral-100">
        <div className="max-w-4xl mx-auto px-4 py-3">
          <Link href="/health-screening" className="inline-flex items-center gap-2 text-sm text-neutral-500 hover:text-brand-900 transition">
            <ArrowLeft size={16} />
            {t('backToScreening')}
          </Link>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="text-neutral-300 text-sm mt-1">{t('serviceDescription')}</p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-neutral-50 p-6 border border-neutral-200">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="text-right">
                      <span className="text-2xl font-bold text-brand-900">¥{price.toLocaleString()}</span>
