...
const DEMO_PRODUCTS = [
  {
    ...
    title: '日本精密健康检查',
    description: '在日本顶级医疗机构进行全面精密体检，享受高端医疗资源与专业中文陪诊服务。',
    stats: [
      { value: '300+', unit: '项', label: '检查项目' },
      { value: '99.2', unit: '%', label: '满意度' },
  ...
  },
  {
    ...
    title: 'SAI 美容外科诊所',
    description: '日本关西领先的医美整形诊所，糸リフト、注射美容、眼鼻整形等项目。',
    stats: [
      { value: '15,000+', unit: '例', label: '累计案例' },
      { value: '98', unit: '%', label: '好评率' },
    ],
    ctaText: '了解详情',
  },
  {
    ...
    title: '干细胞再生医疗',
    description: '日本先端干细胞治疗中心，提供抗衰老、免疫强化、慢性病改善等再生医疗服务。',
    stats: [
