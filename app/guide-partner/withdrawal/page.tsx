...
const translations = {
  ...
  bankIncompleteDesc: {
    ...
    ko: '계정 설정에서 은행 정보를 입력한 후 출금을 신청해 주세요',
  },
  goToSettings: {
    ja: '設定へ →',
    'zh-CN': '前往设置 →',
  ...
  pendingWithdrawalDesc: {
    ...
    ko: '현재 신청이 처리 완료된 후 새로운 신청을 제출해 주세요',
  },
  remitAccount: {
    ja: '振込口座',
    'zh-CN': '汇款账户',
  ...
  submitNote: {
    ...
    ko: '제출 후 재무팀에서 7영업일 이내에 은행 계좌로 송금합니다',
  },
  withdrawalHistory: {
    ja: '出金履歴',
    'zh-CN': '提现记录',
  ...
  errorLoadFailed: {
    ...
    ko: '데이터 로딩에 실패했습니다. 페이지를 새로고침해 주세요',
  },
  errorMinAmount: {
    ja: '最低出金額は',
    'zh-CN': '最低提现金额为',
  ...
  errorWithdrawFailed: {
    ...
    ko: '출금 신청에 실패했습니다. 나중에 다시 시도해 주세요',
  },
  successSubmitted: {
    ...
    ko: '출금 신청이 제출되었습니다. 재무팀에서 7영업일 이내에 은행 계좌로 송금합니다',
  },
  confirmCancel: {
