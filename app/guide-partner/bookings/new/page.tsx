  ...
  if (success) {
    return (
      <div className="min-h-screen bg-zinc-50 flex items-center justify-center p-4">
        <div className="bg-white p-8 max-w-md w-full text-center rounded-xl border border-zinc-200 shadow-sm">
          <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <CheckCircle2 className="w-10 h-10 text-green-600" />
          </div>
          <h2 className="font-sans text-2xl font-bold text-zinc-900 mb-4">{t('bookingSubmitted', lang)}</h2>
          ...
          <div className="space-y-3">
            <Link
              ...
              className="block w-full bg-zinc-900 hover:bg-zinc-800 text-white font-bold py-3 rounded-lg transition"
            >
              {t('goToPayDeposit', lang)}
            </Link>
            <Link
              href="/guide-partner/venues"
              className="block w-full bg-zinc-100 hover:bg-zinc-200 text-zinc-700 font-medium py-3 rounded-lg transition"
            >
      ...
      <main className="lg:ml-64 pt-16 lg:pt-0">
        <div className="p-6 lg:p-8 max-w-2xl">
          ...
          <div className="mb-6">
            ...
            <h1 className="font-sans text-2xl font-bold text-zinc-900">{t('pageTitle', lang)}</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 rounded-lg border border-zinc-200 focus:border-zinc-400 focus:ring-1 focus:ring-zinc-900 resize-none"
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full bg-zinc-900 hover:bg-zinc-800 disabled:bg-zinc-400 text-white font-bold py-4 rounded-lg transition flex items-center justify-center gap-2"
              >
                {submitting ? (
                  <>
