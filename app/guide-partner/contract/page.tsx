...
const translations = {
  ...
  pendingDesc: {
    ...
    ko: '계약서를 다운로드하여 서명 후 스캔본을 업로드해 주세요',
  },
  contractInfo: {
    ja: '契約情報',
    'zh-CN': '协议信息',
  ...
  prohibit1: {
    ...
    ko: '어떠한 명목으로도 의료 기관으로부터 직접 비용이나 이익을 수령할 수 없습니다',
  },
  prohibit2: {
    ...
    ko: '개인 명의로 고객과 의료 관광 계약을 체결할 수 없습니다',
  },
  prohibit3: {
    ...
    ko: '의료 효과를 허위로 홍보할 수 없습니다(\'만병통치\', \'100% 완치\' 등)',
  },
  prohibit4: {
    ...
    ko: '고객의 개인 정보 및 의료 프라이버시를 유출할 수 없습니다',
  },
  downloadTemplate: {
    ja: '契約テンプレートをダウンロード',
    'zh-CN': '下载协议模板',
  ...
  alertSignSuccess: {
    ...
    ko: '서명 업로드가 완료되었습니다! 계약이 활성화되었습니다.',
  },
} as const;
