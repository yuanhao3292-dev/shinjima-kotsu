...
export default function GuideContractPage() {
  ...
  if (loading) return <div className="min-h-screen bg-gray-50 flex items-center justify-center"><div className="text-gray-600">加载中...</div></div>;

  if (!contract) {
    return (
      <div className="min-h-screen bg-gray-50">
        <GuideSidebar pageTitle="佣金协议" />
