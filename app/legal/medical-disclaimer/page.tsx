...
const t: Record<Language, {
  ...
  'zh-TW': {
    ...
    intro: '新島交通株式會社（以下簡稱「本公司」）作為持有大阪府知事登錄旅行業第2-3115號的旅行業者，提供醫療旅遊預約安排及赴日旅行支援服務。本頁面告知與醫療服務相關之重要免責事項。',
    sections: [
      {
        title: '1. 本公司之角色',
        paragraphs: [
          '本公司作為旅行業者，提供與合作醫療機構之預約安排、口譯翻譯、交通住宿安排等旅行服務。本公司並非醫療行為之提供者。',
      ...
      },
      {
        title: '8. 關於赴日旅行風險',
        paragraphs: [
          '從海外赴日之醫療旅遊中，長時間飛行及環境變化可能影響健康狀況。出發前請諮詢主治醫師，判斷是否適合赴日。',
          '本公司對客戶旅途中之健康狀況變化或因旅行引起之健康問題不承擔責任。強烈建議購買海外旅行保險。',
        ],
      },
    ],
    linkYakkan: '旅行業約款',
  ...
  'zh-CN': {
    ...
    intro: '新岛交通株式会社（以下简称"本公司"）作为持有大阪府知事登录旅行业第2-3115号的旅行业者，提供医疗旅游预约安排及赴日旅行支援服务。本页面告知与医疗服务相关之重要免责事项。',
    sections: [
      {
        title: '1. 本公司之角色',
        paragraphs: [
          '本公司作为旅行业者，提供与合作医疗机构之预约安排、口译翻译、交通住宿安排等旅行服务。本公司并非医疗行为之提供者。',
      ...
      },
      {
        title: '8. 关于赴日旅行风险',
        paragraphs: [
          '从海外赴日之医疗旅游中，长时间飞行及环境变化可能影响健康状况。出发前请咨询主治医师，判断是否适合赴日。',
          '本公司对客户旅途中之健康状况变化或因旅行引起之健康问题不承担责任。强烈建议购买海外旅行保险。',
        ],
      },
    ],
    linkYakkan: '旅行业约款',
