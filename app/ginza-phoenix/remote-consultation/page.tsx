...
const pageTranslations = {
  serviceName: { ja: '銀座鳳凰クリニック 遠隔診療サービス', 'zh-TW': '銀座鳳凰クリニック 遠程診斷服務', 'zh-CN': '銀座鳳凰クリニック 远程诊断服务', en: 'Ginza Phoenix Clinic Remote Consultation' } as Record<Language, string>,
  serviceNameEn: { ja: 'Ginza Phoenix Clinic - Remote Consultation', 'zh-TW': 'Ginza Phoenix Clinic - Remote Consultation', 'zh-CN': 'Ginza Phoenix Clinic - Remote Consultation', en: 'Ginza Phoenix Clinic - Remote Consultation' } as Record<Language, string>,
  serviceDescription: { ja: '銀座鳳凰クリニック専門医とのビデオ診察・免疫細胞療法プラン詳細説明・費用詳細見積', 'zh-TW': '與銀座鳳凰クリニック醫生遠程視頻會診、免疫細胞療法方案評估、費用概算', 'zh-CN': '与銀座鳳凰クリニック医生远程视频会诊、免疫细胞疗法方案评估、费用概算', en: 'Video consultation with Ginza Phoenix doctor, immunotherapy assessment, cost estimation' } as Record<Language, string>,
  serviceLongDescription: { ja: '銀座鳳凰クリニックの専門医と遠隔ビデオ診察を行い、専門医療通訳が全行程同行します。免疫細胞療法の適応性、治療計画、治療スケジュール、費用明細等を詳しくご説明し、来日治療の決断をサポートします。', 'zh-TW': '與銀座鳳凰クリニック專科醫生進行遠程視頻會診，由專業醫療翻譯全程陪同。醫生將詳細說明免疫細胞療法的適用性、治療計劃、治療時程、費用明細等，幫助您做出赴日治療的決定。', 'zh-CN': '与銀座鳳凰クリニック专科医生进行远程视频会诊，由专业医疗翻译全程陪同。医生将详细说明免疫细胞疗法的适用性、治疗计划、治疗时程、费用明细等，帮助您做出赴日治疗的决定。', en: 'Remote video consultation with Ginza Phoenix Clinic specialist, with professional medical interpreter. Doctor will explain immunotherapy suitability, treatment plan, schedule, and cost details.' } as Record<Language, string>,
  ...
  feature1: { ja: '銀座鳳凰クリニック専門医とのビデオ診察（約30-60分）', 'zh-TW': '與銀座鳳凰クリニック專科醫生視頻會診（約30-60分鐘）', 'zh-CN': '与銀座鳳凰クリニック专科医生视频会诊(30-60分钟)', en: 'Video consultation with Ginza Phoenix specialist (30-60 mins)' } as Record<Language, string>,
  ...
  feature3: { ja: '免疫細胞療法の適応性評価', 'zh-TW': '免疫細胞療法適應性評估', 'zh-CN': '免疫细胞疗法适应性评估', en: 'Immunotherapy suitability assessment' } as Record<Language, string>,
  ...
  diagnosisPlaceholder: { ja: '例：肺がんIV期、胃がん術後再発等', 'zh-TW': '例如：肺癌IV期、胃癌術後復發等', 'zh-CN': '例如：肺癌IV期、胃癌术后复发等', en: 'e.g., Stage IV lung cancer, gastric cancer recurrence after surgery' } as Record<Language, string>,
...
const SERVICE_INFO = {
  id: MEDICAL_PACKAGES['ginza-phoenix-remote-consultation'].slug,
  slug: MEDICAL_PACKAGES['ginza-phoenix-remote-consultation'].slug,
  price: MEDICAL_PACKAGES['ginza-phoenix-remote-consultation'].priceJpy,
};
...
export default function GinzaPhoenixRemoteConsultationPage() {
  ...
  return (
    <CheckoutLayout>
      ...
      <div className="bg-gradient-to-r from-blue-700 to-cyan-800 py-12">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                  ...
                  <button type="submit" disabled={processing} className="w-full py-4 bg-gradient-to-r from-blue-700 to-cyan-800 text-white font-bold rounded-xl hover:from-blue-800 hover:to-cyan-900 transition shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
