...
const pageTranslations = {
  serviceName: { ja: '銀座鳳凰クリニック 初期相談サービス', 'zh-TW': '銀座鳳凰クリニック 前期諮詢服務', 'zh-CN': '銀座鳳凰クリニック 前期咨询服务', en: 'Ginza Phoenix Clinic Initial Consultation' } as Record<Language, string>,
  ...
  feature2: { ja: '銀座鳳凰クリニックへの初期相談', 'zh-TW': '銀座鳳凰クリニック初步諮詢', 'zh-CN': '銀座鳳凰クリニック初步咨询', en: 'Initial consultation with Ginza Phoenix Clinic' } as Record<Language, string>,
  feature3: { ja: '免疫細胞療法の可行性評価', 'zh-TW': '免疫細胞療法可行性評估', 'zh-CN': '免疫细胞疗法可行性评估', en: 'Immunotherapy feasibility assessment' } as Record<Language, string>,
...
const SERVICE_INFO = {
  id: MEDICAL_PACKAGES['ginza-phoenix-initial-consultation'].slug,
  slug: MEDICAL_PACKAGES['ginza-phoenix-initial-consultation'].slug,
  price: MEDICAL_PACKAGES['ginza-phoenix-initial-consultation'].priceJpy,
};

export default function GinzaPhoenixInitialConsultationPage() {
