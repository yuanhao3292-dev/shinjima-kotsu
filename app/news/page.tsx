                    ...
                    >
                      <div className="flex flex-col md:flex-row md:items-start gap-4">
                        ...
                        <div className="flex items-center gap-3 md:w-32 flex-shrink-0">
                          <div className="w-10 h-10 bg-neutral-100 rounded-lg flex items-center justify-center group-hover:bg-brand-50 transition-colors">
          ...
          {totalPages > 1 && (
            <div className="flex justify-center items-center gap-2 mt-10">
              <button
                ...
                className="w-10 h-10 bg-white border border-neutral-200 flex items-center justify-center text-neutral-600 hover:bg-neutral-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
