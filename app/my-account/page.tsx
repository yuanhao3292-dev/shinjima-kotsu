...
const translations = {
  ...
  aiHealthScreening: { ja: 'AI ヘルスチェック', 'zh-CN': 'AI 健康自测', 'zh-TW': 'AI 健康自測', en: 'AI Health Check' },
  free: { ja: '無料', 'zh-CN': '免费', 'zh-TW': '免費', en: 'Free' },
  aiScreeningDesc: { ja: 'AIが健康上の注意点を分析し、参考情報を提供', 'zh-CN': 'AI 分析健康注意事项，提供参考信息', 'zh-TW': 'AI 分析健康注意事項，提供參考資訊', en: 'AI analyzes health considerations and provides reference information' },
