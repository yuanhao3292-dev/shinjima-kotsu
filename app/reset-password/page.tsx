  ...
  return (
    <MemberLayout showFooter={false}>
      <div className="min-h-[calc(100vh-80px)] flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative brand-gradient-solid">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-neutral-900/66 via-transparent to-neutral-900/32"></div>
