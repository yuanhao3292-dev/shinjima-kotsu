...
export default function VehiclesPage() {
  ...
  return (
    <PublicLayout showFooter={true} activeNav="vehicles">
      ...
      {/* Philosophy Section */}
      <section className="py-20 bg-white" aria-labelledby="philosophy-title">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 id="philosophy-title" className="text-3xl md:text-4xl font-serif font-bold text-gray-900 mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {philosophyItems.map(item => (
              <div key={item.titleKey} className="group">
                <div className={`${item.bgColor} rounded-2xl p-8 h-full border ${item.borderColor} hover:shadow-xl transition-all`}>
                  <div className={`w-14 h-14 ${item.iconBg} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                    <item.icon size={28} className={item.iconColor} aria-hidden="true" />
                  </div>
      ...
      {/* Service Flow */}
      <section className="py-20 bg-gray-50" aria-labelledby="service-flow-title">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 id="service-flow-title" className="text-3xl md:text-4xl font-serif font-bold text-gray-900 mb-4">
              {t('flowTitle1')}<br/>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {serviceFlowSteps.map((item, index) => (
              <div key={item.step} className="relative">
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 h-full">
                  <div className="text-5xl font-bold text-gray-100 mb-4" aria-hidden="true">{item.step}</div>
                ...
                {index < 3 && (
                  <div className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 z-10" aria-hidden="true">
