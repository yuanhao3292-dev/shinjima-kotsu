...
import {
  Car, Shield, Star, Award, Sparkles, Clock, Phone,
  CheckCircle, MapPin, Headphones, BadgeCheck, Users,
} from 'lucide-react';
...
export default function VehiclesContent({ whitelabel }: VehiclesContentProps) {
  ...
  const philosophyItems = useMemo(() => [
    { icon: Sparkles, titleKey: 'comfortTitle' as const, descKey: 'comfortDesc' as const, bgColor: 'bg-orange-50', borderColor: 'border-orange-100', iconBg: 'bg-orange-100', iconColor: 'text-orange-600' },
    { icon: Shield, titleKey: 'safetyTitle' as const, descKey: 'safetyDesc' as const, bgColor: 'bg-blue-50', borderColor: 'border-blue-100', iconBg: 'bg-blue-100', iconColor: 'text-blue-600' },
    { icon: Clock, titleKey: 'punctualTitle' as const, descKey: 'punctualDesc' as const, bgColor: 'bg-green-50', borderColor: 'border-green-100', iconBg: 'bg-green-100', iconColor: 'text-green-600' },
  ], []);
