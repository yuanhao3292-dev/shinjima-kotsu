  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="max-w-md w-full border border-neutral-200 p-8 text-center">
        <div className="mb-6">
          <div className="mx-auto w-16 h-16 bg-brand-100 flex items-center justify-center">
        ...
        <div className="bg-neutral-50 border border-neutral-200 p-4 mb-6 text-left">
          <p className="text-sm text-neutral-700 mb-2">{t('helpText')}</p>
          <p className="text-sm text-neutral-700">{t('helpReady')}</p>
        </div>
