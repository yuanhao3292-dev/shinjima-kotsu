...
const pageTranslations = {
  serviceName: { ja: '大阪国際がんセンター 遠隔診療サービス', 'zh-TW': '大阪國際癌症中心 遠程會診服務', 'zh-CN': '大阪国际癌症中心 远程会诊服务', en: 'OICI Remote Consultation' } as Record<Language, string>,
  serviceNameEn: { ja: 'OICI - Remote Consultation', 'zh-TW': 'OICI - Remote Consultation', 'zh-CN': 'OICI - Remote Consultation', en: 'OICI - Remote Consultation' } as Record<Language, string>,
  serviceDescription: { ja: '大阪国際がんセンター専門医とのビデオ診察・がん治療プラン策定・費用概算', 'zh-TW': '與大阪國際癌症中心專科醫生遠程視頻會診、癌症治療方案制定、費用概算', 'zh-CN': '与大阪国际癌症中心专科医生远程视频会诊、癌症治疗方案制定、费用概算', en: 'Video consultation with OICI cancer specialist, treatment planning, cost estimation' } as Record<Language, string>,
  serviceLongDescription: { ja: '大阪国際がんセンターの専門医と遠隔ビデオ診察を行い、専門医療通訳が全行程同行します。がん治療の適応性、治療スケジュール、入院計画、費用明細等を詳しくご説明し、来日治療の決断をサポートします。', 'zh-TW': '與大阪國際癌症中心專科醫生進行遠程視頻會診，由專業醫療翻譯全程陪同。醫生將詳細說明癌症治療的適用性、治療時程、住院計劃、費用明細等，幫助您做出赴日治療的決定。', 'zh-CN': '与大阪国际癌症中心专科医生进行远程视频会诊，由专业医疗翻译全程陪同。医生将详细说明癌症治疗的适用性、治疗时程、住院计划、费用明细等，帮助您做出赴日治疗的决定。', en: 'Remote video consultation with OICI cancer specialist, with professional medical interpreter. Doctor will explain cancer treatment suitability, treatment schedule, hospitalization plan, and cost details.' } as Record<Language, string>,
  ...
  backToMain: { ja: '大阪国際がんセンターに戻る', 'zh-TW': '返回大阪國際癌症中心', 'zh-CN': '返回大阪国际癌症中心', en: 'Back to OICI' } as Record<Language, string>,
  featuresTitle: { ja: 'サービス内容', 'zh-TW': '服務包含', 'zh-CN': '服务包含', en: 'Service Includes' } as Record<Language, string>,
  feature1: { ja: '大阪国際がんセンター専門医とのビデオ診察（約30-60分）', 'zh-TW': '大阪國際癌症中心專科醫生視頻會診（約30-60分鐘）', 'zh-CN': '大阪国际癌症中心专科医生视频会诊（约30-60分钟）', en: 'Video consultation with OICI cancer specialist (30-60 mins)' } as Record<Language, string>,
  ...
  feature3: { ja: 'がん治療の適応性評価', 'zh-TW': '癌症治療適用性評估', 'zh-CN': '癌症治疗适用性评估', en: 'Cancer treatment suitability assessment' } as Record<Language, string>,
  ...
  prereq3: { ja: '大阪国際がんセンターの初期評価完了', 'zh-TW': '大阪國際癌症中心已完成初步評估', 'zh-CN': '大阪国际癌症中心已完成初步评估', en: 'OICI completed initial assessment' } as Record<Language, string>,
...
const SERVICE_INFO = {
  id: MEDICAL_PACKAGES['oici-remote-consultation'].slug,
  slug: MEDICAL_PACKAGES['oici-remote-consultation'].slug,
  price: MEDICAL_PACKAGES['oici-remote-consultation'].priceJpy,
};

export default function OICIRemoteConsultationPage() {
  ...
  const backHref = guideSlug ? `/g/${guideSlug}/oici` : '/oici';
