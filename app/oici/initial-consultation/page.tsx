...
const pageTranslations = {
  serviceName: { ja: '大阪国際がんセンター 初期相談サービス', 'zh-TW': '大阪國際癌症中心 前期諮詢服務', 'zh-CN': '大阪国际癌症中心 前期咨询服务', en: 'OICI Initial Consultation' } as Record<Language, string>,
  serviceNameEn: { ja: 'OICI - Initial Consultation', 'zh-TW': 'OICI - Initial Consultation', 'zh-CN': 'OICI - Initial Consultation', en: 'OICI - Initial Consultation' } as Record<Language, string>,
  serviceDescription: { ja: '病歴翻訳・大阪国際がんセンター相談・治療可能性評価・費用概算', 'zh-TW': '病歷翻譯、大阪國際癌症中心諮詢、治療可行性評估、費用概算', 'zh-CN': '病历翻译、大阪国际癌症中心咨询、治疗可行性评估、费用概算', en: 'Medical record translation, OICI consultation, treatment assessment, cost estimate' } as Record<Language, string>,
  serviceLongDescription: { ja: '大阪国際がんセンター向けの初期相談サービス。診療情報を翻訳（中→日）し、大阪国際がんセンターと初期相談を行い、がん治療の適応性を評価し、費用概算をご提供します。', 'zh-TW': '專為大阪國際癌症中心提供的前期諮詢服務。我們將翻譯您的病歷資料（中→日），並與大阪國際癌症中心進行初步諮詢，評估癌症治療的可行性並提供費用概算。', 'zh-CN': '专为大阪国际癌症中心提供的前期咨询服务。我们将翻译您的病历资料（中→日），并与大阪国际癌症中心进行初步咨询，评估癌症治疗的可行性并提供费用概算。', en: 'Initial consultation for Osaka International Cancer Center (OICI). We translate your medical records (CN→JP), consult with the center, assess cancer treatment feasibility and provide cost estimates.' } as Record<Language, string>,
  ...
  feature2: { ja: '大阪国際がんセンターへの初期相談', 'zh-TW': '大阪國際癌症中心初步諮詢', 'zh-CN': '大阪国际癌症中心初步咨询', en: 'Initial consultation with OICI' } as Record<Language, string>,
  feature3: { ja: 'がん治療の適応性評価', 'zh-TW': '癌症治療可行性評估', 'zh-CN': '癌症治疗可行性评估', en: 'Cancer treatment feasibility assessment' } as Record<Language, string>,
...
const SERVICE_INFO = {
  id: MEDICAL_PACKAGES['oici-initial-consultation'].slug,
  slug: MEDICAL_PACKAGES['oici-initial-consultation'].slug,
  price: MEDICAL_PACKAGES['oici-initial-consultation'].priceJpy,
};

export default function OICIInitialConsultationPage() {
