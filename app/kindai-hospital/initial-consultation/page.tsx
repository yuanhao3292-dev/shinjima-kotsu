...
const pageTranslations = {
  serviceName: { ja: '近畿大学病院 初期相談サービス', 'zh-TW': '近畿大學醫院 前期諮詢服務', 'zh-CN': '近畿大学医院 前期咨询服务', en: 'Kindai University Hospital Initial Consultation' } as Record<Language, string>,
  serviceNameEn: { ja: 'Kindai University Hospital - Initial Consultation', 'zh-TW': 'Kindai University Hospital - Initial Consultation', 'zh-CN': 'Kindai University Hospital - Initial Consultation', en: 'Kindai University Hospital - Initial Consultation' } as Record<Language, string>,
  serviceDescription: { ja: '病歴翻訳・近畿大学病院相談・治療可能性評価・費用概算', 'zh-TW': '病歷翻譯、近畿大學醫院諮詢、治療可行性評估、費用概算', 'zh-CN': '病历翻译、近畿大学医院咨询、治疗可行性评估、费用概算', en: 'Medical record translation, Kindai University Hospital consultation, treatment assessment, cost estimate' } as Record<Language, string>,
  serviceLongDescription: { ja: '近畿大学病院向けの初期相談サービス。診療情報を翻訳（中→日）し、近畿大学病院と初期相談を行い、がんゲノム医療・集学的治療（MDT）の適応性を評価し、費用概算をご提供します。', 'zh-TW': '專為近畿大學醫院提供的前期諮詢服務。我們將翻譯您的病歷資料（中→日），並與近畿大學醫院進行初步諮詢，評估癌症基因組醫療及多學科團隊（MDT）治療的可行性並提供費用概算。', 'zh-CN': '专为近畿大学医院提供的前期咨询服务。我们将翻译您的病历资料（中→日），并与近畿大学医院进行初步咨询，评估癌症基因组医疗及多学科团队（MDT）治疗的可行性并提供费用概算。', en: 'Initial consultation for Kindai University Hospital. We translate your medical records (CN→JP), consult with the hospital, assess cancer genomic medicine and multi-disciplinary team (MDT) treatment feasibility and provide cost estimates.' } as Record<Language, string>,
  ...
  feature2: { ja: '近畿大学病院への初期相談', 'zh-TW': '近畿大學醫院初步諮詢', 'zh-CN': '近畿大学医院初步咨询', en: 'Initial consultation with Kindai University Hospital' } as Record<Language, string>,
  feature3: { ja: 'がん治療・先進医療の適応性評価', 'zh-TW': '癌症治療·先進醫療可行性評估', 'zh-CN': '癌症治疗·先进医疗可行性评估', en: 'Cancer treatment & advanced medicine feasibility assessment' } as Record<Language, string>,
  ...
  doc1: { ja: '最新の診療経過・診断書', 'zh-TW': '最新診療經過·診斷書', 'zh-CN': '最新诊疗经过·诊断书', en: 'Latest medical records & diagnosis' } as Record<Language, string>,
  doc2: { ja: 'CT/MRI等の画像検査データ', 'zh-TW': 'CT/MRI等影像檢查數據', 'zh-CN': 'CT/MRI等影像检查数据', en: 'CT/MRI imaging data' } as Record<Language, string>,
  doc3: { ja: '血液検査報告', 'zh-TW': '血液檢查報告', 'zh-CN': '血液检查报告', en: 'Blood test report' } as Record<Language, string>,
  doc4: { ja: '現在の治療内容（化学療法等）', 'zh-TW': '目前治療內容（化療等）', 'zh-CN': '目前治疗内容（化疗等）', en: 'Current treatment details (chemotherapy, etc.)' } as Record<Language, string>,
  ...
  currentStatusPlaceholder: { ja: '現在受けている治療や病状の経過をご記入ください', 'zh-TW': '請簡述目前的治療情況及病情經過', 'zh-CN': '请简述目前的治疗情况及病情经过', en: 'Brief description of current treatment and disease progression' } as Record<Language, string>,
...
const SERVICE_INFO = {
  ...
  slug: MEDICAL_PACKAGES['kindai-initial-consultation'].slug,
  price: MEDICAL_PACKAGES['kindai-initial-consultation'].priceJpy,
};

export default function KindaiInitialConsultationPage() {
