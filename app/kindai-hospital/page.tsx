...
export const metadata: Metadata = {
  title: '近畿大学病院 | 南大阪の大学附属医院 - 新岛交通医疗服务',
  description:
    '近畿大学病院は南大阪地域の大学病院。800床、35診療科、14専門医療センターを有し、がん治療、心臓血管治療、脳卒中治療など高度医療を提供。高精度PET-CT完備。',
  keywords:
    '近畿大学病院,大学病院,がんセンター,PET-CT,多学科診療,MDT,堺市,南大阪,癌症中心,大学附属医院',
  openGraph: {
    title: '近畿大学病院 | 南大阪の大学附属医院',
    description:
      '南大阪地域の大学病院。がんセンターをはじめ14の専門医療センターで高度医療を提供。',
    images: [
      {
