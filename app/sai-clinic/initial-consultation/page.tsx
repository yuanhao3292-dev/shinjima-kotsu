...
const pageTranslations = {
  serviceName: { ja: 'SAI CLINIC 初期相談サービス', 'zh-TW': 'SAI CLINIC 前期諮詢服務', 'zh-CN': 'SAI CLINIC 前期咨询服务', en: 'SAI CLINIC Initial Consultation' } as Record<Language, string>,
  serviceNameEn: { ja: 'SAI CLINIC - Initial Consultation', 'zh-TW': 'SAI CLINIC - Initial Consultation', 'zh-CN': 'SAI CLINIC - Initial Consultation', en: 'SAI CLINIC - Initial Consultation' } as Record<Language, string>,
  serviceDescription: { ja: 'カウンセリング・SAI CLINIC相談・美容整形プラン評価・費用概算', 'zh-TW': '諮詢翻譯、SAI CLINIC諮詢、醫美整形方案評估、費用概算', 'zh-CN': '咨询翻译、SAI CLINIC咨询、医美整形方案评估、费用概算', en: 'Consultation, SAI CLINIC assessment, cosmetic surgery plan evaluation, cost estimate' } as Record<Language, string>,
  serviceLongDescription: { ja: 'SAI CLINIC大阪梅田向けの初期相談サービス。お悩みや写真資料を翻訳（中→日）し、SAI CLINICと初期カウンセリングを行い、糸リフト・二重整形・ヒアルロン酸注入等の美容整形プランの適応性を評価し、費用概算をご提供します。', 'zh-TW': '專為SAI CLINIC大阪梅田提供的前期諮詢服務。我們將翻譯您的諮詢資料及照片（中→日），並與SAI CLINIC進行初步諮詢，評估線雕提升、雙眼皮、玻尿酸注射等醫美整形方案的可行性並提供費用概算。', 'zh-CN': '专为SAI CLINIC大阪梅田提供的前期咨询服务。我们将翻译您的咨询资料及照片（中→日），并与SAI CLINIC进行初步咨询，评估线雕提升、双眼皮、玻尿酸注射等医美整形方案的可行性并提供费用概算。', en: 'Initial consultation for SAI CLINIC Osaka Umeda. We translate your consultation materials and photos (CN→JP), consult with the clinic, assess cosmetic procedure feasibility including thread lift, double eyelid surgery, hyaluronic acid injections, and provide cost estimates.' } as Record<Language, string>,
  ...
  feature1: { ja: '相談資料・写真の翻訳（中→日）', 'zh-TW': '諮詢資料·照片翻譯（中→日）', 'zh-CN': '咨询资料·照片翻译（中→日）', en: 'Consultation materials & photo translation (CN→JP)' } as Record<Language, string>,
  feature2: { ja: 'SAI CLINICへの初期カウンセリング', 'zh-TW': 'SAI CLINIC初步諮詢', 'zh-CN': 'SAI CLINIC初步咨询', en: 'Initial consultation with SAI CLINIC' } as Record<Language, string>,
  feature3: { ja: '美容整形施術の適応性評価', 'zh-TW': '醫美整形療程可行性評估', 'zh-CN': '医美整形疗程可行性评估', en: 'Cosmetic surgery feasibility assessment' } as Record<Language, string>,
  ...
  doc1: { ja: '気になる部位の最近の写真', 'zh-TW': '在意部位的近期照片', 'zh-CN': '在意部位的近期照片', en: 'Recent photos of areas of concern' } as Record<Language, string>,
  doc2: { ja: '過去の美容整形歴（ある場合）', 'zh-TW': '過往醫美整形記錄（如有）', 'zh-CN': '过往医美整形记录（如有）', en: 'Previous cosmetic surgery history (if any)' } as Record<Language, string>,
  doc3: { ja: 'アレルギー・既往歴', 'zh-TW': '過敏及病史', 'zh-CN': '过敏及病史', en: 'Allergy & medical history' } as Record<Language, string>,
  doc4: { ja: '現在の服用薬', 'zh-TW': '目前服用藥物', 'zh-CN': '目前服用药物', en: 'Current medications' } as Record<Language, string>,
  ...
  currentStatus: { ja: '現在のお悩み', 'zh-TW': '目前困擾', 'zh-CN': '目前困扰', en: 'Current Concerns' } as Record<Language, string>,
  currentStatusPlaceholder: { ja: '気になる部位やお悩みをご記入ください', 'zh-TW': '請描述您在意的部位或困擾', 'zh-CN': '请描述您在意的部位或困扰', en: 'Describe areas of concern' } as Record<Language, string>,
...
const SERVICE_INFO = {
  id: MEDICAL_PACKAGES['sai-initial-consultation'].slug,
  slug: MEDICAL_PACKAGES['sai-initial-consultation'].slug,
  price: MEDICAL_PACKAGES['sai-initial-consultation'].priceJpy,
};

export default function SaiClinicInitialConsultationPage() {
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                  ...
                  <button type="submit" disabled={processing} className="w-full py-4 bg-gradient-to-r from-blue-700 to-blue-900 text-white font-bold rounded-xl hover:from-blue-600 hover:to-blue-800 transition shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
