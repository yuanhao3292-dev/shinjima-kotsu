...
const COLOR_THEMES: Record<string, { headerBg: string; button: string; cardBg: string; cardBorder: string; check: string; title: string; price: string }> = {
  ...
  amber: { headerBg: 'bg-brand-900', button: 'bg-accent-400 text-brand-900 hover:bg-accent-300', cardBg: 'bg-neutral-50', cardBorder: 'border-neutral-200', check: 'text-accent-700', title: 'text-brand-900', price: 'text-brand-900' },
