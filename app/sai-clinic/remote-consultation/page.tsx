...
export default function SaiClinicRemoteConsultationPage() {
  ...
  async function handleConfirmedSubmit() {
    ...
    try {
      ...
      fullNotes += `${t('cancerType')}: ${patientInfo.cancerType || t('notProvided')}\n`;
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-neutral-700 mb-1">{t('cancerType')}</label>
                      <input type="text" value={patientInfo.cancerType} onChange={(e) => setPatientInfo({ ...patientInfo, cancerType: e.target.value })} className="w-full px-4 py-3 border border-neutral-200 focus:ring-2 focus:ring-brand-700 focus:border-transparent" placeholder={t('cancerTypePlaceholder')} />
                    </div>
