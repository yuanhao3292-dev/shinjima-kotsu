...
const pageTranslations = {
  serviceName: { ja: 'IGTクリニック 初期相談サービス', 'zh-TW': 'IGT診所 前期諮詢服務', 'zh-CN': 'IGT诊所 前期咨询服务', en: 'IGT Clinic Initial Consultation' } as Record<Language, string>,
  serviceNameEn: { ja: 'IGT Clinic - Initial Consultation', 'zh-TW': 'IGT Clinic - Initial Consultation', 'zh-CN': 'IGT Clinic - Initial Consultation', en: 'IGT Clinic - Initial Consultation' } as Record<Language, string>,
  serviceDescription: { ja: '病歴翻訳・IGTクリニック相談・血管内治療可能性評価・費用概算', 'zh-TW': '病歷翻譯、IGT診所諮詢、血管內治療可行性評估、費用概算', 'zh-CN': '病历翻译、IGT诊所咨询、血管内治疗可行性评估、费用概算', en: 'Medical record translation, IGT Clinic consultation, endovascular treatment assessment, cost estimate' } as Record<Language, string>,
  serviceLongDescription: { ja: 'IGTクリニック向けの初期相談サービス。診療情報を翻訳（中→日）し、IGTクリニックと初期相談を行い、血管内治療・温熱療法の適応性を評価し、費用概算をご提供します。', 'zh-TW': '專為IGT診所提供的前期諮詢服務。我們將翻譯您的病歷資料（中→日），並與IGT診所進行初步諮詢，評估血管內治療及溫熱療法的可行性並提供費用概算。', 'zh-CN': '专为IGT诊所提供的前期咨询服务。我们将翻译您的病历资料（中→日），并与IGT诊所进行初步咨询，评估血管内治疗及温热疗法的可行性并提供费用概算。', en: 'Initial consultation for IGT Clinic. We translate your medical records (CN→JP), consult with the clinic, assess endovascular therapy and hyperthermia feasibility and provide cost estimates.' } as Record<Language, string>,
  ...
  feature2: { ja: 'IGTクリニックへの初期相談', 'zh-TW': 'IGT診所初步諮詢', 'zh-CN': 'IGT诊所初步咨询', en: 'Initial consultation with IGT Clinic' } as Record<Language, string>,
  feature3: { ja: '血管内治療・温熱療法の適応性評価', 'zh-TW': '血管內治療·溫熱療法可行性評估', 'zh-CN': '血管内治疗·温热疗法可行性评估', en: 'Endovascular therapy & hyperthermia feasibility assessment' } as Record<Language, string>,
...
const SERVICE_INFO = {
  id: MEDICAL_PACKAGES['igtc-initial-consultation'].slug,
  slug: MEDICAL_PACKAGES['igtc-initial-consultation'].slug,
  price: MEDICAL_PACKAGES['igtc-initial-consultation'].priceJpy,
};

export default function IGTCInitialConsultationPage() {
