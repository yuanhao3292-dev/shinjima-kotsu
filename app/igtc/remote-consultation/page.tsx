...
const pageTranslations = {
  serviceName: { ja: 'IGTクリニック 遠隔診療サービス', 'zh-TW': 'IGT診所 遠程會診服務', 'zh-CN': 'IGT诊所 远程会诊服务', en: 'IGT Clinic Remote Consultation' } as Record<Language, string>,
  serviceNameEn: { ja: 'IGT Clinic - Remote Consultation', 'zh-TW': 'IGT Clinic - Remote Consultation', 'zh-CN': 'IGT Clinic - Remote Consultation', en: 'IGT Clinic - Remote Consultation' } as Record<Language, string>,
  serviceDescription: { ja: 'IGTクリニック専門医とのビデオ診察・血管内治療プラン策定・費用概算', 'zh-TW': '與IGT診所專科醫生遠程視頻會診、血管內治療方案制定、費用概算', 'zh-CN': '与IGT诊所专科医生远程视频会诊、血管内治疗方案制定、费用概算', en: 'Video consultation with IGT Clinic specialist, endovascular treatment planning, cost estimation' } as Record<Language, string>,
  serviceLongDescription: { ja: 'IGTクリニックの堀院長と遠隔ビデオ診察を行い、専門医療通訳が全行程同行します。血管内治療・温熱療法の適応性、治療スケジュール、入院計画、費用明細等を詳しくご説明し、来日治療の決断をサポートします。', 'zh-TW': '與IGT診所堀院長進行遠程視頻會診，由專業醫療翻譯全程陪同。醫生將詳細說明血管內治療及溫熱療法的適用性、治療時程、住院計劃、費用明細等，幫助您做出赴日治療的決定。', 'zh-CN': '与IGT诊所堀院长进行远程视频会诊，由专业医疗翻译全程陪同。医生将详细说明血管内治疗及温热疗法的适用性、治疗时程、住院计划、费用明细等，帮助您做出赴日治疗的决定。', en: 'Remote video consultation with IGT Clinic Director Dr. Hori, with professional medical interpreter. Doctor will explain endovascular therapy and hyperthermia suitability, treatment schedule, hospitalization plan, and cost details.' } as Record<Language, string>,
  ...
  backToMain: { ja: 'IGTクリニックに戻る', 'zh-TW': '返回IGT診所', 'zh-CN': '返回IGT诊所', en: 'Back to IGT Clinic' } as Record<Language, string>,
  featuresTitle: { ja: 'サービス内容', 'zh-TW': '服務包含', 'zh-CN': '服务包含', en: 'Service Includes' } as Record<Language, string>,
  feature1: { ja: 'IGTクリニック堀院長とのビデオ診察（約30-60分）', 'zh-TW': 'IGT診所堀院長視頻會診（約30-60分鐘）', 'zh-CN': 'IGT诊所堀院长视频会诊（约30-60分钟）', en: 'Video consultation with IGT Clinic Director Dr. Hori (30-60 mins)' } as Record<Language, string>,
  ...
  feature3: { ja: '血管内治療・温熱療法の適応性評価', 'zh-TW': '血管內治療·溫熱療法適用性評估', 'zh-CN': '血管内治疗·温热疗法适用性评估', en: 'Endovascular therapy & hyperthermia suitability assessment' } as Record<Language, string>,
  feature4: { ja: '個別治療計画とスケジュール説明', 'zh-TW': '個人治療計劃與時程說明', 'zh-CN': '个人治疗计划与时程说明', en: 'Personalized treatment plan and schedule' } as Record<Language, string>,
  ...
  prereq3: { ja: 'IGTクリニックの初期評価完了', 'zh-TW': 'IGT診所已完成初步評估', 'zh-CN': 'IGT诊所已完成初步评估', en: 'IGT Clinic completed initial assessment' } as Record<Language, string>,
...
const SERVICE_INFO = {
  id: MEDICAL_PACKAGES['igtc-remote-consultation'].slug,
  slug: MEDICAL_PACKAGES['igtc-remote-consultation'].slug,
  price: MEDICAL_PACKAGES['igtc-remote-consultation'].priceJpy,
};

export default function IGTCRemoteConsultationPage() {
