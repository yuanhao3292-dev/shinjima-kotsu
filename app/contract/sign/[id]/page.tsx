    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-brand-50 to-brand-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-neutral-900 mb-2">合同已签署</h1>
          ...
          <div className="bg-neutral-50 rounded-lg p-4 text-left">
            <div className="text-sm text-neutral-600 mb-1">合同编号</div>
            <div className="font-mono text-neutral-900">{contract.contract_number}</div>
          </div>
          {contract.pdf_url && (
            <a
              ...
              className="mt-6 block w-full py-3 bg-brand-600 text-white rounded-lg hover:bg-brand-700 transition-colors"
            >
              下载合同 PDF
            </a>
          )}
