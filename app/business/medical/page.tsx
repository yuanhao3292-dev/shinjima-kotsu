...
const pageTranslations = {
  ...
  sectionPartnerHospitals: {
    ...
    'zh-TW': '主要合作醫療機構',
    'zh-CN': '主要合作医疗机构',
    en: 'Major Partner Medical Institutions',
  },
  timcBadge: {
    ja: '公式予約代理店',
    'zh-TW': '官方預約代理',
    'zh-CN': '官方预约代理',
    en: 'Official Booking Agent',
  },
  timcDesc: {
  ...
  timcTag1: {
    ...
    'zh-TW': 'JR大阪站直達',
    'zh-CN': 'JR大阪站直达',
    en: 'Direct access from JR Osaka',
  },
  timcTag3: {
    ja: '中国語対応',
    'zh-TW': '中文服務',
    'zh-CN': '中文服务',
    en: 'Chinese Available',
  },
  ctaTitle: {
    ja: '医療サービスについてのお問い合わせ',
    'zh-TW': '醫療服務諮詢',
    'zh-CN': '医疗服务咨询',
    en: 'Medical Service Inquiries',
  },
  ctaSubtitle: {
...
export default function MedicalBusinessPage() {
  ...
  const services = [
    {
      title: t('serviceCheckup') as string,
      description: t('serviceCheckupDesc') as string,
      features: t('serviceCheckupFeatures') as string[],
    },
    {
      title: t('serviceCancer') as string,
      description: t('serviceCancerDesc') as string,
      features: t('serviceCancerFeatures') as string[],
    },
    {
      title: t('serviceRegen') as string,
      description: t('serviceRegenDesc') as string,
      features: t('serviceRegenFeatures') as string[],
    },
    {
      title: t('serviceSupport') as string,
      description: t('serviceSupportDesc') as string,
      features: t('serviceSupportFeatures') as string[],
    },
  ];
